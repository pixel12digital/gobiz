            ...
            if ($request->ajax()) {
                ...
                return DataTables::of($products)
                    ...
                    ->addColumn('product_category', function ($product) {
                        return '<span class="badge bg-primary text-white text-capitalize">' . __($product->product_category->category_name) . '</span>';
                    })
                    ...
                    ->rawColumns(['product_category', 'product_status', 'actions'])
                    ->make(true);
            }
