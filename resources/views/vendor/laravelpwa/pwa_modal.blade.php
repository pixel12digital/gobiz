    ...
    <div class="flex items-end justify-center min-h-screen">
        <div class="bg-white rounded-lg p-6 lg:w-2/5">
            ...
            <div class="flex justify-end">
                <button id="addToHomeScreenButton" class="px-4 py-2 text-white bg-gray-800 rounded hover:bg-gray-600 focus:outline-none focus:bg-gray-600">{{ __('Install') }}</button>
                <button id="closeModal" class="ml-2 px-4 py-2 text-white bg-gray-500 rounded hover:bg-gray-500 focus:outline-none focus:bg-gray-500">{{ __('Cancel') }}</button>
            </div>
        </div>
    </div>
</div>
