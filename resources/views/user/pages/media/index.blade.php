...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="page-body">
            <div class="container-fluid" id="mediaIframe">
                {{-- Failed --}}
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="container-fluid d-flex flex-column justify-content-center">
                            <div class="container-fluid my-auto">
                                <div class="empty">
                                    <div class="empty-img"><svg class="img" xmlns="http://www.w3.org/2000/svg"
                                            height="256" fill="none" viewBox="0 0 800 600">
                                            <style>
                                            ...
                                            <path
                                                ...
                                                fill="#FFCB9D"
                                                style="fill: #FFCB9D; fill: var(--tblr-illustrations-skin, #FFCB9D);"></path>
                                            <path
        ...
        <div class="container-fluid">
            ...
            <div class="card" id="showPagination">
                <div class="card-footer d-flex align-items-center" id="paginationLinks">
                    <p class="m-0 text-secondary">{{ __('Showing') }} <span id="paginationStartIndex"></span> {{ __('to') }} <span id="paginationEndIndex"></span> {{ __('of') }} <span id="paginationTotalCount"></span> {{ __('results') }}</p>
                    <ul class="pagination m-0 ms-auto">
                        <li class="page-item" id="prevPageBtn">
                            <a class="page-link" onclick="loadPreviousPage()">
...
@section('scripts')
        ...
        function displayMediaCards(mediaData) {
            ...
            mediaData.forEach(function(media) {
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="${media.base_url}${media.media_url}" class="card-img-top p-3" style="height: 200px; object-fit: cover;" alt="${media.media_name}">
                        <div class="card-body">
                            <h4 class="card-title m-0 media-name">${media.media_name}</h4>
                            <small class="text-muted">{{ __('Upload on:') }} ${media.formatted_created_at}</small>
    ...
    <script>
        ...
        function deleteMedia(id) {
            ...
            document.getElementById("delete_status").innerHTML = `{{ __("Do you want to remove this file?") }}`;
