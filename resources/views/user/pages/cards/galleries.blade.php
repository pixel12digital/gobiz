                    ...
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('user.save.galleries', Request::segment(3)) }}" method="post"
                            ...
                            <div class="card-footer text-end">
                                <div class="d-flex">
                                  <a href="{{ route('user.testimonials', Request::segment(3)) }}" class="btn btn-outline-primary ms-2">{{ __('Skip') }}</a>
                        ...
                        "<div class='col-md-6 col-xl-6'>" +
                            "<div class='mb-3'>" +
                                "<label class='form-label'>" +
                                    "{{ __('Image Caption') }}" +
                                "</label>" +
                                "<input type='text' class='form-control' name='caption[]' placeholder='{{ __('Image Caption') }}'>" +
