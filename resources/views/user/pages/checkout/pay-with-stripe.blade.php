                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="mt-2 text-muted text-underline" href="{{ route('stripe.payment.cancel', $paymentId) }}">
            ...
            (async function() {
                ...
                form.addEventListener('submit', async (event) => {
                    ...
                    const { error } = await stripe.confirmPayment({
                        elements,
                        confirmParams: {
                            return_url: '{{ route('stripe.payment.status', $paymentId) }}', // Optional: Redirect URL on success
                        },
                    });
