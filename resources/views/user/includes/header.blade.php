<header class="navbar navbar-expand-md d-none d-lg-flex d-print-none">
    <div class="container-{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'xl' : 'fluid' }}">
        ...
        <div class="d-flex align-items-center justify-content-end w-100">
            {{-- Light / Dark Mode --}}
            <a href="{{ route('user.change.theme', 'dark') }}" class="hide-theme-dark border rounded-3 p-2">
            ...
            <a href="{{ route('user.change.theme', 'light') }}" class="hide-theme-light border rounded-3 p-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
