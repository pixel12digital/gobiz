...
<head>
    ...
    {{-- Tailwind CSS --}}
    <link rel="stylesheet" href="{{ url('templates/css/flower-shop.css') }}">
...
<body class="bg-pink-100 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto lg:my-10 pb-10 lg:pb-0">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
                ...
                <div class="bg-white lg:rounded-3xl shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden relative">
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="h-60 lg:h-96 relative p-3 lg:p-6" id="profile">
                            <img src="{{ url('img/templates/flower-shop/banner.png') }}"
                    ...
                    <div class="px-3 lg:px-6 pb-12 lg:pb-6">
                        ...
                        {{-- Background Image --}}
                        <div class="text-center mt-12 relative flex px-6">
                            <img src="{{ asset('img/templates/flower-shop/profile-bg.png') }}" alt=""
                                class="w-32 lg:w-40 absolute lg:-top-11 -top-9 -left-3" />
                            <img src="{{ asset('img/templates/flower-shop/bg.png') }}" alt=""
                                class="w-full absolute top-0 left-0 -mt-12 rounded-t-3xl" />
                            {{-- Profile Image --}}
                            ...
                            <div class="relative z-10 flex flex-col ltr:ml-4 rtl:mr-4 ltr:lg:ml-6 rtl:lg:mr-6">
                                ...
                                {{-- Job Title --}}
                                <p class="text-pink-700 text-base font-bold mt-1 text-md text-start">
                                        ...
                                        @foreach ($feature_details as $feature)
                                            @if (in_array($feature->type, ['tel', 'address', 'wa']))
                                                ...
                                                @if ($feature->type == 'address')
                                                    <a href="#location"
                                                        class="bg-pink-100 hover:bg-pink-200 rounded-full flex items-center justify-center w-14 h-14 border border-pink-300 focus:outline-none">
                                                        <i class="{{ $feature->icon }} fa-xl text-pink-700"></i>
                                                    </a>
                                                @endif
                                                {{-- Phone --}}
                                                @if ($feature->type == 'tel')
                                                ...
                                                @if ($feature->type == 'wa')
                                                    <a href="https://wa.me/{{ $feature->content }}"
                                                        class="bg-pink-100 hover:bg-pink-200 rounded-full flex items-center justify-center w-14 h-14 border border-pink-300 focus:outline-none">
                                                        <i class="{{ $feature->icon }} fa-2xl text-pink-700"></i>
                                                    </a>
                                                @endif
                                            @endif
                                        @endforeach
                            ...
                            @foreach ($feature_details as $feature)
                                @if (in_array($feature->type, ['address']))
                                    <div class="flex justify-center relative">
                                        <div class="bg-cover bg-center transition-colors rounded-2xl border border-pink-300 w-full relative"
                                            style="background-image: url('{{ asset('img/templates/flower-shop/card-bg.png') }}')">
                                            <!-- Font Awesome Icon -->
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank" class="p-6 text-white flex flex-col">
                                                {{-- Icon --}}
                                                <i class="{{ $feature->icon }} fa-xl text-pink-600 text-2xl py-2"></i>
                                                <!-- Title -->
                                                <h2 class="text-lg font-semibold mt-1.5 text-gray-800">
                                                    {{ $feature->label }}
                                                </h2>
                                                <!-- Description -->
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            @php
                                ...
                                $excludedTypes = ['tel', 'address', 'map', 'iframe', 'youtube'];
                            ...
                            @if ($validFeatures->isNotEmpty())
                                <div class="relative">
                                    <img src="{{ asset('img/templates/flower-shop/4.png') }}" alt=""
                                        class="w-36 lg:w-44 absolute -top-0 lg:-top-3 -right-14 lg:-right-20 animate-move-y" />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                        <div
                                            class="absolute bottom-10 left-1/2 h-1.5 w-16 bg-pink-600 -translate-x-1/2 rounded-full">
                                        </div>
                                        {{ __('Social Links') }}
                                    </h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        @foreach ($validFeatures as $feature)
                                            ...
                                            <a href="{{ $href }}" target="_blank"
                                                class="p-4 transition-colors bg-cover bg-center rounded-2xl flex flex-col border border-pink-300 bg-pink-100 relative"
                                                style="background-image: url('{{ asset('img/templates/flower-shop/card-bg.png') }}')">
                                                <!-- Font Awesome Icon -->
                                                <div
                                                    class="flex items-center justify-center border border-pink-300 bg-pink-100 w-9 h-9 rounded-full -ml-1">
                                                    <i class="{{ $feature->icon }} text-pink-600 text-xl"></i>
                                                </div>
                                                <!-- Title -->
                                                <h2 class="text-base font-semibold mt-1 text-pink-600">
                                                    {{ $feature->label }}</h2>
                                                <!-- Description -->
                                                <p class="text-sm truncate text-gray-700">{{ $feature->content }}</p>
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        @if (count($product_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/flower-shop/2.png') }}" alt=""
                                    class="w-36 lg:w-44 absolute -top-5 lg:-top-9 -left-14 lg:-left-20 animate-move-y" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-10 left-1/2 h-1.5 w-16 bg-pink-600 -translate-x-1/2 rounded-full">
                                        ...
                                        <swiper-slide class="p-1">
                                            <div
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <p
                                                        class="absolute top-9 right-9 font-medium text-white bg-pink-600 px-4 py-1 rounded-full">
                                                    ...
                                                    <div class="flex-flex-col">
                                                        ...
                                                        <div>
                                                            <h4 class=" text-lg font-bold">
                                                                {{ __('Stock:') }} <span
                                                                    class="font-medium text-{{ $product_detail->product_status == 'instock' ? 'pink-600' : 'red-500' }}">{{ $product_detail->product_status == 'outstock' ? __('Out of Stock') : __('In Stock') }}</span>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                        ...
                                                        @if ($whatsAppNumberExists == true)
                                                            <div class="mt-4 w-full">
                                                                <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                    target="_blank"
                                                                    class="text-white rounded-xl text-lg w-full px-12 lg:w-auto bg-pink-600 border border-pink-700 text-base font-semibold py-1.5 transition-colors block text-center">
                                                                    {{ __('Enquire') }}
                                                                </a>
                                                            </div>
                                                        @endif
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/flower-shop/5.png') }}" alt=""
                                    class="w-28 lg:w-36 absolute -top-0 lg:-top-3 -right-12 lg:-right-20 animate-move-y" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-10 left-1/2 h-1.5 w-16 bg-pink-600 -translate-x-1/2 rounded-full">
                                    ...
                                    <swiper-container class="mySwiper" autoplay-delay="3000"
                                        ...
                                        @foreach ($galleries_details as $galleries_detail)
                                            <swiper-slide class="p-1">
                                                <!-- Gallery -->
                                                <div
                                                    class="flex items-center justify-center bg-white rounded-t-2xl px-4 pt-4 shadow-[0_0_4px_rgba(0,0,0,0.1)] h-80 overflow-hidden">
                                                    <img class="w-full h-full object-cover rounded-t-2xl {{ $galleries_detail->caption ? '' : 'rounded-b-2xl' }}"
                                                        src="{{ url($galleries_detail->gallery_image) }}"
                                                        alt="{{ $galleries_detail->caption }}" />
                                                </div>
                                                {{-- Title --}}
                                                @if ($galleries_detail->caption)
                                                <div class="text-center bg-pink-200 p-4 rounded-b-2xl">
                                        ...
                                        @if ($feature->type == 'youtube')
                                            ...
                                            <div class="rounded-2xl overflow-hidden">
                                                ...
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-pink-200 rounded-b-2xl">
                                                        <div class="mb-2">
                                    ...
                                    @foreach ($feature_details as $feature)
                                        @if ($feature->type == 'iframe')
                                            <div class="rounded-2xl overflow-hidden">
                                                ...
                                                {{-- Add Iframe title --}}
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-pink-200">
                                                        <div class="mb-2">
                                                            <div class="text-gray-800 font-semibold text-lg mb-2">
                                                                {{ $feature->label }}
                                                            </div>
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/flower-shop/6.png') }}" alt=""
                                    class="w-32 lg:w-36 absolute top-1 lg:-top-2 -right-9 lg:-right-6 animate-move-y" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-10 left-1/2 h-1.5 w-16 bg-pink-600 -translate-x-1/2 rounded-full">
                                ...
                                <swiper-container class="mySwiper" autoplay-delay="3000"
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        <div class="swiper-slide">
                                            <div class="bg-cover bg-center p-6 relative rounded-2xl border border-pink-300"
                                                style="background-image: url('{{ asset('img/templates/flower-shop/card-bg.png') }}')">
                                                {{-- Image --}}
                                                ...
                                                {{-- Review --}}
                                                <p class="text-gray-600 text-lg italic">"{{ $testimonial->review }}"
                                                </p>
                                                <p class="text-pink-600 font-medium text-md mt-2 text-right mr-2">
                                                    {{-- Name --}}
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ asset('img/templates/flower-shop/1.png') }}" alt=""
                                    class="w-28 lg:w-36 absolute top-2 lg:-top-2 -left-12 lg:-left-16 animate-move-y" />
                                ...
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        ...
                                        <div class="shadow-[0_0_4px_rgba(0,0,0,0.1)] border border-pink-300 bg-cover bg-center overflow-hidden border rounded-2xl p-6 relative"
                                            style="background-image: url('{{ asset('img/templates/flower-shop/card-bg.png') }}')">
                                            ...
                                            <div class="flex flex-col justify-between mb-4 space-y-2">
                                                ...
                                                <input type="text" id="appointment-date"
                                                    class="flatpickr-input w-full px-4 py-3 text-gray-800 bg-white border border-gray-300 rounded-xl focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-600 focus:ring-opacity-50"
                                                    placeholder="{{ __('Select a date') }}" />

                                                <!-- Select time in dropdown -->
                                                <select id="time-slot-select"
                                                    class="w-full px-4 py-3 text-gray-800 bg-white border border-gray-300 rounded-xl focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-600 focus:ring-opacity-50">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-3 bg-pink-600 text-white text-lg text-center rounded-xl font-semibold border border-pink-700"
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        <!-- {{ $payment->label }} -->
                                        <div class="flex flex-col border border-pink-300 bg-cover bg-center rounded-2xl p-4 relative"
                                            style="background-image: url('{{ asset('img/templates/flower-shop/card-bg.png') }}')">
                                            <div class="flex justify-between items-center">
                                                <!-- {{ $payment->label }} Icon -->
                                                <i class="{{ $payment->icon }} text-pink-600 text-4xl"></i>
                                                ...
                                                @if ($payment->type == 'url')
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <div
                                                            class="border border-pink-300 bg-pink-100 rounded-full p-2 flex items-center justify-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-pink-600 h-6 w-6">
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                <section class="relative">
                                    <img src="{{ asset('img/templates/flower-shop/7.png') }}" alt=""
                                    class="w-24 lg:w-28 absolute top-5 lg:-top-0 -right-9 lg:-right-14 animate-move-y" />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                        <div
                                            class="absolute bottom-10 left-1/2 h-1.5 w-16 bg-pink-600 -translate-x-1/2 rounded-full">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-pink-100 text-pink-600 border border-pink-300 rounded-full">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @if (count($feature_details) > 0 && $feature_details->contains('type', 'map'))
                            <div class="relative">
                                <img src="{{ asset('img/templates/flower-shop/9.png') }}" alt=""
                                    class="w-28 lg:w-36 absolute top-0 lg:-top-2 -left-14 lg:-left-20 animate-move-y" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-10 left-1/2 h-1.5 w-16 bg-pink-600 -translate-x-1/2 rounded-full">
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative pb-14 lg:pb-6">
                                    <img src="{{ asset('img/templates/flower-shop/8.png') }}" alt=""
                                    class="w-28 lg:w-36 absolute top-7 lg:-top-0 -right-5 lg:-right-9" />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                        <div
                                            class="absolute bottom-10 left-1/2 h-1.5 w-16 bg-pink-600 -translate-x-1/2 rounded-full">
                                    ...
                                    @if (Session::has('message'))
                                        <div
                                            class="px-6 py-4 bg-pink-100 border-t-4 border-pink-100 rounded-lg shadow-md mb-6">
                                    ...
                                    <form
                                        class="w-full max-w-full border p-6 rounded-2xl bg-cover bg-center border-pink-300 relative"
                                        style="background-image: url('{{ asset('img/templates/flower-shop/card-bg.png') }}')"
                                        ...
                                        <div class="grid grid-cols-1 gap-2 lg:gap-6 lg:grid-cols-2">
                                            ...
                                            <div class="grid grid-cols-1 gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="name"
                                                        ...
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-pink-300 focus:ring-2 focus:ring-pink-600 focus:ring-opacity-50"
                                                        required />
                                                </div>
                                                {{-- Email --}}
                                                <div>
                                            ...
                                            <div class="h-full pb-8">
                                                ...
                                                <textarea name="message" placeholder="{{ __('Your Message') }}"
                                                    class="w-full h-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-600 focus:ring-opacity-50 focus:border-pink-300 resize-none"
                                        ...
                                        <div class="mt-6">
                                            <button type="submit"
                                                class="w-full px-4 py-4 bg-pink-600 text-white text-xl font-semibold rounded-xl focus:outline-none border border-pink-700 hover:bg-pink-2000">
                                                {{ __('Send') }}
                                            </button>
                                        </div>
                                    </form>
            ...
            <div
                class="fixed w-full left-1/2 bottom-0 px-2 bg-pink-300/60 border border-pink-300 backdrop-blur-md py-4 flex lg:hidden md:hidden transform -translate-x-1/2 z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="border border-pink-300 p-3 rounded-full bg-pink-50" href="#profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-user text-pink-600 h-6 w-6">
                ...
                <!-- Send Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-pink-300 p-3 rounded-full bg-pink-50"
                        onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-send text-pink-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M10 14l11 -11" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="border border-pink-300 p-3 rounded-full bg-pink-50">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-pink-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-pink-300 p-3 rounded-full bg-pink-50"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-line-scan text-pink-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-pink-300 p-3 rounded-full bg-pink-50"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-share text-pink-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <form id="appointmentForm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit" id="bookAppointmentButton"
                            class="bg-pink-600 text-white px-4 py-2 rounded-lg hover:bg-pink-600">
                            {{ __('Submit') }}
                        </button>
                    </div>
                </form>
        ...
        <div id="shareModal"
            ...
            <div class="bg-white rounded-xl w-full max-w-md p-6 mx-4 space-y-6" onclick="event.stopPropagation()">
                ...
                <div class="flex justify-around text-pink-600">
                    <a href="{{ $shareComponent['facebook'] }}" target="_blank" class="hover:text-pink-700">
                        <i class="fab fa-facebook fa-2x"></i>
                    </a>
                    <a href="{{ $shareComponent['twitter'] }}" target="_blank" class="hover:text-pink-700">
                        <i class="fab fa-twitter fa-2x"></i>
                    </a>
                    <a href="{{ $shareComponent['linkedin'] }}" target="_blank" class="hover:text-pink-700">
                        <i class="fab fa-linkedin fa-2x"></i>
                    </a>
                    <a href="{{ $shareComponent['whatsapp'] }}" target="_blank" class="hover:text-pink-700">
                        <i class="fab fa-whatsapp fa-2x"></i>
                    </a>
                    <a href="{{ $shareComponent['telegram'] }}" target="_blank" class="hover:text-pink-700">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-pink-600 text-white font-bold py-2 px-4 rounded-xl w-full border border-pink-700">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
        ...
        <div id="whatsappModal"
            ...
            <div class="bg-pink-100 border-pink-300 rounded-3xl w-full max-w-md p-6 mx-4 space-y-6"
                ...
                <div>
                    ...
                    <input type="text" id="whatsappNumber" placeholder="e.g., +919876543210"
                        class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:border-pink-300 focus:ring-2 focus:ring-pink-600 focus:ring-opacity-50" />
                </div>
        ...
        <div id="scanModal"
            ...
            <!-- Modal content (stops propagation to prevent closing when clicking inside) -->
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 border-pink-300 bg-pink-100 qr-modal-overlay"
                onclick="event.stopPropagation()">
                <!-- Qr Code -->
                ...
                <!-- Submit Button -->
                <div class="flex justify-center">
                    <button onclick="downloadQr('{{ route('dynamic.card', $business_card_details->card_id) }}', 500)"
                        id="download" class="bg-pink-100 border border-pink-300 font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-pink-600 h-6 w-6">
                                ...
                                <form action="{{ route('check.pwd', $business_card_details->card_id) }}"
                                    ...
                                    <div class="flex">
                                        <input type="password" name="password"
                                            class="rounded rounded-r-lg bg-pink-100 border text-pink-800 focus:ring-pink-100 focus:border-pink-100 block flex-1 min-w-0 w-full text-sm border-pink-100 p-2.5"
                                    ...
                                    <div class="flex flex-col space-y-4 mt-3">
                                        <button type="submit"
                                            class="bg-pink-1000 text-white px-4 py-2 mt-2 rounded-lg hover:bg-pink-2000 transition duration-300">{{ __('Password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
