...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/spa.css') }}">
    {{-- Swiper CSS --}}
...
<body class="bg-green-50 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto lg:my-8 relative">        
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
                ...
                <div class="bg-white lg:rounded-2xl shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden">
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-60 relative" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/spa/banner.png') }}"
                    ...
                    <div class="relative px-6 -mt-0.5 pb-32 lg:p-6">
                        ...
                        <div class="text-center mt-4 relative -mx-6">
                            <img src="{{ url('img/templates/spa/bg.png') }}" alt="{{ $business_card_details->title }}"
                                class="w-full object-cover absolute -top-[89px] z-10" />
                            <img src="{{ url('img/templates/spa/7.png') }}" alt=""
                                class="h-36 lg:h-48 absolute -top-1 -left-10" />
                            <div class="relative z-10">
                                {{-- Name --}}
                                <h1 class="lg:text-5xl text-3xl font-medium text-[#121212] pDetails">
                                    {{ $business_card_details->title }}
                                </h1>
                                {{-- Job Title --}}
                                <p class="text-green-500 font-bold mt-2 text-md">
                                    ...
                                    @if (in_array($feature->type, ['tel', 'email', 'instagram', 'snapchat', 'address']))
                                        ...
                                        @if ($feature->type == 'tel')
                                            <a href="tel:{{ $feature->content }}"
                                                class="bg-green-50 p-4 rounded-full text-green-500 hover:bg-green-100 transition-colors border border-green-100 z-20">
                                                <i class="{{ $feature->icon }} fa-xl text-green-500"></i>
                                            </a>
                                        @endif
                                ...
                                @if (in_array($feature->type, ['address']))
                                    <div class="grid grid-cols-1 gap-4 relative">
                                        <div class="mt-8 bg-green-50 hover:bg-green-100 transition-colors rounded-2xl border border-green-100 w-full bg-cover bg-center"
                                            style="background-image: url('img/templates/spa/card-bg.png')">
                                            <!-- Font Awesome Icon -->
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank"
                                                class="px-6 py-4 text-green-500 flex flex-col justify-center">
                                                <!-- Font Awesome Icon -->
                                                <i
                                                    class="{{ $feature->icon }} fa-xl text-green-500 text-2xl py-4"></i>
                                                <!-- Title -->
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            ...
                            @if ($validFeatures->isNotEmpty())
                                <div class="relative">
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative pDetails">
                                        <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-green-500 -mx-6 "></div>
                                        {{ __('Social Links') }}
                                    </h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        @foreach ($validFeatures as $feature)
                                            ...
                                            <a href="{{ $href }}" target="_blank"
                                                class="p-4 text-green-500 hover:bg-green-100 transition-colors rounded-2xl flex flex-col border border-green-100 bg-cover bg-center"
                                                style="background-image: url('img/templates/spa/card-bg.png')">
                                                <!-- Font Awesome Icon -->
                                                <i class="{{ $feature->icon }} text-green-500 text-xl -mt-1 mb-1"></i>
                                                <!-- Title -->
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/spa/9.png') }}" alt=""
                                    class="w-44 absolute -top-1 -right-[120px]" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative pDetails">
                                    <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-green-500 -mx-6"></div>
                                    {{ __('Services') }}
                                                ...
                                                @if ($enquiry_button != null)
                                                    @if ($whatsAppNumberExists == true && $whatsAppNumberExists == true && $service_detail->enable_enquiry == 'Enabled')
                                                        <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                            target="_blank"
                                                            class="text-green-500 text-center text-sm font-semibold mt-4 bg-transparent border border-green-500 py-2 px-4 rounded-lg hover:bg-green-500 hover:text-white focus:outline-none">
                                                            {{ __('Enquire') }}
                                                        </a>
                                                    @endif
                                                @endif
                                        ...
                                        <swiper-slide class="p-0.5">
                                            ...
                                            <div
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <p
                                                        class="absolute top-9 right-9 font-medium text-[#F8F9FA] bg-green-500 px-4 py-1.5 rounded-full">
                                                    ...
                                                    @if ($enquiry_button != null)
                                                        @if ($whatsAppNumberExists == true)
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                target="_blank"
                                                                class="text-green-500 text-sm font-semibold bg-transparent border block text-center border-green-500 py-2 px-4 rounded-lg hover:bg-green-500 hover:text-white focus:outline-none">
                                                                {{ __('Enquire') }}
                                                            </a>
                                                        @endif
                                                    @endif
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/spa/8.png') }}" alt=""
                                    class="w-44 absolute -top-1 -left-24" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative pDetails">
                                    <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-green-500 -mx-6"></div>
                                    {{ __('Gallery') }}
                                        ...
                                        @foreach ($galleries_details as $galleries_detail)
                                            <swiper-slide class="p-0.5">
                                                ...
                                                <div
                                                    ...
                                                    <h3
                                                        class="py-3 bg-green-50 border border-green-100 mb-3 text-green-500 text-lg w-full text-center rounded-2xl ">
                                            ...
                                            <div class="overflow-hidden rounded-2xl">
                                                ...
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-green-50  ">
                                                        <div class="text-green-500 font-semibold text-lg text-center">
                                                            {{ $feature->label }}
                                                        </div>
                                                    </div>
                                                @endif
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/spa/2.png') }}" alt=""
                                    class="w-32 absolute top-1 -right-[60px] z-20 transform scale-x-[-1] -rotate-12" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-800 py-12 text-center relative pDetails">
                                    <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-green-500 -mx-6"></div>
                                    {{ __('Client Reviews') }}
                                </h2>
                                <swiper-container class="mySwiper" autoplay-delay="2000"
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        ...
                                        <swiper-slide class="p-1">
                                            <div
                                                class="mb-2 flex flex-col items-center justify-center bg-white p-6 shadow-[0_0_4px_rgba(0,0,0,0.1)] text-center rounded-2xl">
                                                {{-- Image --}}
                                                <img class="w-20 h-20 rounded-full mb-2 object-cover"
                                                    src="{{ url($testimonial->reviewer_image) }}"
                                                    alt="{{ $testimonial->reviewer_name }}" />
                                                {{-- Name --}}
                                                <h4 class="text-green-500 font-bold text-center ">
                            ...
                            <div class="relative">
                                ...
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        <h2
                                            class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative pDetails">
                                            <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-green-500 -mx-6">
                                            </div>
                                            {{ __('Appointment') }}
                                        </h2>
                                        ...
                                        <div
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-3 bg-green-500 rounded-xl text-[#F8F9FA] text-lg text-center font-semibold border border-gray-200"
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div class="flex flex-col border border-green-100 rounded-2xl p-4 bg-cover bg-center"
                                            style="background-image: url('img/templates/spa/card-bg.png')">
                                            <div class="flex justify-between items-center">
                                                <!-- {{ $payment->label }} Icon -->

                                                <i class="{{ $payment->icon }} text-green-500 text-4xl"></i>
                                                    ...
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                ...
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-green-500 h-6 w-6">
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                <section class="pt-8 relative">
                                    <img src="{{ url('img/templates/spa/6.png') }}" alt=""
                                        class="w-40 absolute top-2 -left-[80px]" />
                                    <!-- Section Header -->
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative pDetails">
                                        <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-green-500 -mx-6"></div>
                                    ...
                                    <div class="bg-white rounded-lg py-4">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-green-500 text-[#f8f9fa] rounded-full">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-start space-x-4">
                                                <!-- Animated Icon -->
                                                <div
                                                    class="flex items-center justify-center w-12 h-12 bg-green-100 text-green-500 rounded-full transform hover:scale-110 transition-transform duration-300 ease-in-out">
                            ...
                            <div class="relative" id="location">
                                ...
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type == 'map')
                                        {{-- Map title --}}
                                        @if ($feature->label != null)
                                            <div class="px-5 py-3 bg-green-50 rounded-t-2xl">
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    <img src="{{ url('img/templates/spa/10.png') }}" alt=""
                                        class="lg:w-36 w-32 absolute top-2 -right-[40px] -rotate-12" />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative pDetails">
                                        <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-green-500 -mx-6"></div>
                                        {{ __('Contact Us') }}
                                    ...
                                    @if (Session::has('message'))
                                        <div class="px-6 py-4 bg-green-500 shadow-md mb-6">
                                    ...
                                    <form class="w-full max-w-full shadow-[0_0_4px_rgba(0,0,0,0.1)] p-8 rounded-2xl"
                                        ...
                                        <div class="flex flex-col lg:flex-row gap-4 mb-2">
                                            <div class="flex flex-col w-full lg:w-1/2">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-80" required />
                                            </div>
                                            <div class="flex flex-col w-full lg:w-1/2">
                                                <label for="email"
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <textarea name="message" placeholder="{{ __('Your Message') }}"
                                                class="w-full px-4 py-2 border border-gray-300 focus:outline-none rounded-lg focus:ring-2 focus:ring-green-500 focus:ring-opacity-80" required></textarea>
                                        </div>
                                        ...
                                        <div class="flex flex-col ">
                                            <button type="submit"
                                                class="w-full px-4 py-3 bg-green-500 text-white text-xl font-semibold focus:outline-none rounded-xl">
                                                {{ __('Send') }}
                                            </button>
                                        </div>
                                    </form>
            ...
            <div
                class="fixed w-11/12 left-1/2 bottom-4 bg-green-200/40 border border-green-500 rounded-full backdrop-blur-md py-4 px-3 flex lg:hidden md:hidden transform -translate-x-1/2 z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="border border-green-300 p-3 rounded-full bg-green-200" href="#profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-user text-green-500 h-6 w-6">
                ...
                <!-- Send Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-green-300 p-3 rounded-full bg-green-200"
                        onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-send text-green-500 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M10 14l11 -11" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="border border-green-300 p-3 rounded-full bg-green-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-green-500 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-green-300 p-3 rounded-full bg-green-200"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-line-scan text-green-500 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-green-300 p-3 rounded-full bg-green-200"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-share text-green-500 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div id="shareModal"
            ...
            <div class="bg-white rounded-xl w-full max-w-md p-6 mx-4 space-y-6" onclick="event.stopPropagation()">
                ...
                <div class="flex justify-around text-green-500">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-green-500 text-white font-bold py-2 px-4 rounded-xl w-full">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white" onclick="event.stopPropagation()">
                ...
                <div>
                    ...
                    <input type="text" id="whatsappNumber" placeholder="{{ __('e.g., +919876543210') }}"
                        class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:border-green-300 focus:ring-2 focus:ring-green-100" />
                </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white qr-modal-overlay"
                ...
                <div class="flex justify-center">
                    <button id="download"
                        ...
                        class="bg-green-200 border border-green-300 font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-green-500 h-6 w-6">
                            ...
                            <div class="mt-6 space-y-4">
                                <form action="{{ route('check.pwd', $business_card_details->card_id) }}"
                                    ...
                                    <div class="flex flex-col space-y-4 mt-3">
                                        <button type="submit"
                                            class="bg-green-500 text-white rounded-xl px-4 py-2 mt-2 transition duration-300">{{ __('Password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
