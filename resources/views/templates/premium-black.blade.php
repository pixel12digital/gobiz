...
<head>
    ...
    <link rel="stylesheet" href="{{ url('templates/css/saaspro-vcard-styles.css') }}" />
...
<body class="antialiased bg-grey-lighter text-body font-body"
    ...
    <div id="preloader" class="fixed inset-0 bg-gray-50 flex items-center justify-center z-50">
        <!-- Preloader spinner -->
        <div class="w-16 h-16 border-4 border-t-transparent border-black rounded-full animate-spin"></div>
    </div>
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl">
                    ...
                    <div
                        class="max-w-xl w-full mx-auto bg-white rounded-lg overflow-hidden shadow-lg relative">
                        ...
                        @if ($business_card_details->cover_type == 'photo')
                            <div class="bottom-style-6">
                                <div class="bg-cover bg-center h-48"
                                    style="background-image: url('{{ $business_card_details->cover ? url($business_card_details->cover) : asset('images/default-cover.png') }}'); "></div>
                            </div>
                        @endif
                        ...
                        <div class="border-b px-4 {{ $business_card_details->cover_type == 'none' ? 'pt-16' : 'xl:pt-32' }} flex flex-row">
                                        ...
                                        <div class="p-4 bg-white border-2 rounded-lg">
                                            ...
                                            <div class="w-full mb-1 justify-between items-center">
                                                <h4 class="lg:text-xl text-md font-black mb-3 text-dark mt-2 flex">
                                                    <p class="lg:text-md text-sm font-black lg:mr-3 mr-1">
                                                        <span
                                                            id="{{ $product_detail->product_id }}_currency">{{ $product_detail->currency }}</span> <span
                                                    ...
                                                    @if ($product_detail->sales_price != $product_detail->regular_price)
                                                        <p
                                                            class="lg:text-md text-sm font-black line-through text-red-500 float-right">
                                                            {{ $product_detail->currency }} {{ formatCurrency($product_detail->regular_price) }}
                                                        </p>
                                                    @endif
                                                </h4>
                                                @if ($enquiry_button != null)
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.appointment', ['section_bg' => 'black', 'bg_color' => 'white', 'btn_color' => 'black', 'text_color' => 'white'])
                        @endif
