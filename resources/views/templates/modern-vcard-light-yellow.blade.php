            ...
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen p-1">
                    ...
                    <div
                        ...
                        <div class="border-b px-4 pb-2 {{ $business_card_details->cover_type == 'none' ? 'pt-24' : '' }}">
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.modern-appointment', ['bg_color' => 'white', 'btn_color' => 'yellow-500', 'text_color' => 'gray-700'])
                        @endif
