...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/musician.css') }}">
    {{-- Slick --}}
...
<body class="bg-orange-50 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            {{-- Check business details --}}
            @if ($business_card_details != null)
                <div class="bg-[#fbe2c6] shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden" data-aos="fade-up">

                    <!-- Start Cover Image Section -->
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-60 p-6" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/musician/banner.png') }}"
                    ...
                    <div class="-mt-0.5 pb-32 lg:pb-6 px-6">
                        ...
                        <div class="text-center mt-4 relative flex">
                            ...
                            <div class="w-4/12 md:w-3/12">
                                <div class="w-32 h-32 md:w-40 md:h-40 relative ">
                                    <!-- Background Image -->
                                    <div style="background-image: url('{{ asset('img/templates/musician/profile-border.png') }}');"
                                        class="w-full h-full bg-cover absolute top-0 left-0 z-20">
                                    </div>
                                    <!-- Foreground Image -->
                                    <img src="{{ url($business_card_details->profile) }}"
                                        alt="{{ $business_card_details->title }}"
                                        class="w-28 h-28 md:w-36 md:h-36 rounded-full object-cover absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10" />
                                </div>
                            </div>

                            <div class="relative z-10 flex flex-col w-9/12 ltr:ml-6 rtl:mr-6">
                                {{-- Name --}}
                                <h1 class="lg:text-4xl text-3xl font-medium text-black head text-start">
                                    {{ $business_card_details->title }}
                                </h1>
                                {{-- Job Title --}}
                                <p class="text-gray-700 font-bold mt-1 text-md text-start">
                                    {{ $card_details->sub_title }}
                                </p>
                                {{-- About --}}
                                @if (optional($business_card_details)->description || optional($business_card_details)->address)
                                    <div
                                        class="mt-2 text-base text-gray-500 leading-relaxed font-medium line-clamp-4 text-start">
                                        ...
                                        @foreach ($feature_details as $feature)
                                            @if (in_array($feature->type, ['tel', 'address', 'wa']))
                                                ...
                                                @if ($feature->type == 'address')
                                                    <a href="#location"
                                                        class="bg-[#f7a76c] rounded-full flex items-center justify-center w-14 h-14 border border-orange-400 focus:outline-none">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 relative">
                                        <div class="mt-4 w-full">
                                            ...
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank"
                                                class="px-6 py-4 text-white border border-orange-400 flex flex-col bg-[#f7a76c] rounded-2xl justify-center focus:outline-none">
                                                <!-- Font Awesome Icon -->
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            ...
                            @if ($visibleFeatures->isNotEmpty())
                                <div class="relative">
                                    <img src="{{ asset('img/templates/musician/1.png') }}" alt=""
                                        class="w-28 lg:w-36 absolute top-3 -left-12" />
                                    <h2
                                        ...
                                        @foreach ($feature_details as $feature)
                                            ...
                                            @if (!in_array($feature->type, ['tel', 'map', 'iframe', 'youtube', 'address']))
                                                ...
                                                <a href="{{ $href }}" target="_blank"
                                                    class="p-4 bg-[#f7a76c] border border-orange-400 transition-colors rounded-2xl flex flex-col focus:outline-none">
                                                    <!-- Font Awesome Icon -->
                        ...
                        @if (count($product_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/musician/7.png') }}" alt=""
                                    class="w-12 lg:w-16 absolute top-3 -right-6" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                ...
                                <div class="slider">
                                    ...
                                    @foreach ($product_details as $product_detail)
                                        <div
                                            class="flex flex-col bg-white justify-center border p-6 rounded-3xl shadow-[0_0_4px_rgba(0,0,0,0.1)]">
                                            {{-- Badge --}}
                                            @if (!empty($product_detail->badge))
                                                <p
                                                    class="absolute top-9 right-9 font-medium text-white bg-[#f7a76c] px-4 py-1 rounded-xl">
                                                    ...
                                                    @if ($whatsAppNumberExists == true)
                                                        <div class="mt-2 w-full">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                target="_blank"
                                                                class="text-white w-full px-12 lg:w-auto bg-[#f7a76c] border border-orange-400 text-base py-2 transition-colors block text-center rounded-xl">
                                                                {{ __('Enquire') }}
                                                            </a>
                                                        </div>
                                                    @endif
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/musician/2.png') }}" alt=""
                                    class="w-32 lg:w-40 absolute top-0 -left-10" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-[#f7a76c] -translate-x-1/2">
                                    </div>
                                ...
                                <div class="slider">
                                    ...
                                    @foreach ($service_details as $service_detail)
                                        <!-- Service -->
                                        <div
                                            class="flex bg-white border rounded-3xl shadow-[0_0_4px_rgba(0,0,0,0.1)] justify-center p-6">
                                            {{-- Image --}}
                        ...
                        @if ($feature_details->where('type', 'youtube')->count() > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/musician/8.png') }}" alt=""
                                    class="w-14 lg:w-20 absolute top-4 -right-6" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-[#f7a76c] -translate-x-1/2">
                                    </div>
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/musician/3.png') }}" alt=""
                                    class="w-32 lg:w-40 absolute top-6 -left-12" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-[#f7a76c] -translate-x-1/2">
                                    </div>
                                    ...
                                    @foreach ($galleries_details as $galleries_detail)
                                        <div class="">
                                            ...
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <h3
                                                    class="text-center py-2 text-white bg-[#f7a76c] rounded-b-2xl text-lg w-full">
                                            ...
                                            <div class="grid grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-[#f7a76c] text-[#f8f9fa] rounded-full">
                                                        ...
                                                        <!-- Day and Hours -->
                                                        <div>
                                                            <p class="text-sm font-medium text-black capitalize">
                                                                {{ __($day) }}</p>
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ asset('img/templates/musician/4.png') }}" alt=""
                                    class="w-12 lg:w-16 absolute top-6 -right-6" />
                                ...
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        ...
                                        <div
                                            class="overflow-hidden border p-10 bg-[#f7a76c] border border-orange-400 rounded-2xl">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-3 bg-orange-500 border border-orange-600 rounded-xl text-white text-lg text-center font-medium focus:outline-none focus:ring-2 focus:ring-orange-500"
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div
                                            class="flex flex-col rounded-2xl p-4 bg-[#f7a76c] border border-orange-400">
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/musician/5.png') }}" alt=""
                                    class="w-36 lg:w-44 absolute -top-1 -left-16" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                    <div class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-[#f7a76c] -translate-x-1/2">
                                    </div>
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    <img src="{{ asset('img/templates/musician/6.png') }}" alt=""
                                        class="w-32 lg:w-48 absolute -top-6 -right-12 -rotate-12" />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-black py-12 text-center relative head">
                                        <div
                                            class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-[#f7a76c] -translate-x-1/2">
                                    ...
                                    @if (Session::has('message'))
                                        <div class="py-4 bg-[#f7a76c] shadow-md mb-6 rounded-2xl">
                                    ...
                                    <form
                                        class="w-full max-w-full border p-6 rounded-2xl bg-[#f7a76c] border border-orange-400 relative z-10"
                                        ...
                                        <button type="submit"
                                            class="w-full px-4 py-3 bg-orange-500 border border-orange-600 text-white text-xl font-medium rounded-2xl focus:outline-none">
                                            {{ __('Send') }}
                                        </button>
                                    </form>
                                </div>
                                ...
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type == 'map')
                                        <div>
                                            ...
                                            {{-- Map title --}}
                                            @if ($feature->label != null)
                                                <div class="px-5 py-3 bg-[#f7a76c] rounded-b-2xl">
                                                    <div class="text-white font-medium text-lg">
                                                        {{ $feature->label }}
                                                    </div>
                                                </div>
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div
                                ...
                                <div class="mt-2 text-gray-600">
                                    {{ __('Copyright') }} &copy;
                                    <a class="text-orange-400" href="{{ url($card_details->card_url) }}">
                        ...
                        @else
                            <div
                                ...
                                <div class="mt-2 text-gray-600">
                                    {{ __('Made with') }}
                                    <a class="text-orange-400" href="{{ env('APP_URL') }}">
                                        {{ config('app.name') }} </a>
                                    <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                </div>
                            </div>
            ...
            <div
                class="fixed w-11/12 left-1/2 bottom-4 bg-orange-200/60 border border-orange-400 rounded-full backdrop-blur-md py-4 px-3 flex lg:hidden md:hidden transform -translate-x-1/2 z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="border border-orange-400 p-3 rounded-full bg-orange-300" href="#profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-user text-orange-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <button class="border border-orange-400 p-3 rounded-full bg-orange-300"
                        onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-send text-orange-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M10 14l11 -11" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="border border-orange-400 p-3 rounded-full bg-orange-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-orange-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <button class="border border-orange-400 p-3 rounded-full bg-orange-300"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-line-scan text-orange-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <button class="border border-orange-400 p-3 rounded-full bg-orange-300"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-share text-orange-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="bg-orange-50 rounded-2xl w-full max-w-md p-6 mx-4 shadow-lg">
                ...
                <form id="appointmentForm">
                    ...
                    <div class="flex justify-between">
                        <button type="button" class="bg-orange-500 text-white px-4 py-2 rounded-lg"
                            onclick="validateAndShowModal()">
                            {{ __('Close') }}
                        </button>
        ...
        <div id="shareModal"
            ...
            <div class="bg-orange-50 rounded-2xl w-full max-w-md p-6 mx-4 space-y-6"
                ...
                <div class="flex justify-around text-orange-500">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-orange-500 border border-orange-600 text-white font-bold py-2 px-4 rounded-2xl w-full">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-orange-50"
                ...
                <div class="flex justify-center">
                    <button onclick="sendMessage()"
                        class="bg-orange-500 border border-orange-600 text-white font-bold py-3 px-4 rounded-2xl w-full focus:outline-none focus:ring-2 focus:ring-orange-500">
                        {{ __('Send') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-orange-50 qr-modal-overlay"
                ...
                <div class="flex justify-center">
                    <button id="download"
                        ...
                        class="bg-orange-500 border border-orange-600 font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
