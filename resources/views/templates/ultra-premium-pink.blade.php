                ...
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl"
                    ...
                    <div
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.appointment', ['section_bg' => 'pink-600', 'bg_color' => 'white', 'btn_color' => 'pink-600', 'text_color' => 'white'])
                        @endif
                    ...
                    <div
                        ...
                        <div class="modal-content py-4 text-left px-6">
                            <div class="justify-between items-center">
                                ...
                                <button
                                    class="flex justify-center items-center content-center bg-pink-700 h-14 w-12 py-2 px-16 fill-current text-white"
                                    onclick="sendVcard()">
                                    {{ __('Send') }}
                                </button>
                            </div>
