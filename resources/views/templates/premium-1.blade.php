        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl">
                    ...
                    <div
                        class="max-w-xl w-full mx-auto bg-white border-2 overflow-hidden border-black relative {{ $business_card_details->cover_type == "none" ? '' : 'pt-0' }}">
                        ...
                        <div class="border-b mt-2 px-4 pt-3 flex flex-row {{ $business_card_details->cover_type == 'none' ? 'pt-8' : '' }}">
