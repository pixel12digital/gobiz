            ...
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl"
                    ...
                    <div
                        ...
                        <div class="border-b px-4 {{ $business_card_details->cover_type == 'none' ? 'pt-16' : 'pt-5' }} flex flex-row">
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.appointment', ['section_bg' => 'indigo-600', 'bg_color' => 'white', 'btn_color' => 'indigo-600', 'text_color' => 'white'])
                        @endif
                    ...
                    <div
                        ...
                        <div class="modal-content py-4 text-left px-6">
                            <div class="justify-between items-center">
                                ...
                                <button
                                    class="flex justify-center items-center content-center bg-indigo-700 h-14 w-12 py-2 px-16 fill-current text-white"
                                    onclick="sendVcard()">
                                    {{ __('Send') }}
                                </button>
                            </div>
