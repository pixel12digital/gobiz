        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl">
                    ...
                    <div
                        class="max-w-xl w-full mx-auto bg-white rounded-lg overflow-hidden shadow-lg relative {{ $business_card_details->cover_type == "none" ? '' : 'pt-0' }}">
                        ...
                        <div class="border-b mt-2 px-4 pt-3 flex flex-row {{ $business_card_details->cover_type == 'none' ? 'pt-8' : 'xl:pt-32' }}">
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.appointment', ['section_bg' => 'lime-800', 'bg_color' => 'white', 'btn_color' => 'lime-800', 'text_color' => 'white'])
                        @endif
