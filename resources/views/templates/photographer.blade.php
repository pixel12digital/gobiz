...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/photographer.css') }}">
    {{-- Slick --}}
...
<body class="bg-orange-100 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto  ">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            {{-- Check business details --}}
            @if ($business_card_details != null)
                <div class="bg-gradient-to-tl from-[#ffa48c] to-[#ffd1a8] shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden lg:my-10 lg:rounded-2xl"
                    data-aos="fade-up">
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-60 p-6" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/photographer/banner.png') }}"
                    ...
                    <!-- Profile Info -->
                    <div class="-mt-0.5 pb-32 lg:pb-6 px-6">
                        <!-- Start Profile Info -->

                        {{-- Background Image --}}
                        <div class="text-center mt-10 relative flex">
                            <img src="{{ asset('img/templates/photographer/9.png') }}" alt=""
                                class="w-28 lg:w-36 absolute -top-16 ltr:-right-2  opacity-80 -rotate-12" />
                            {{-- Profile Image --}}
                            <div class="w-4/12 md:w-3/12">
                                <div class="w-32 h-32 md:w-44 md:h-44 relative ">
                                    <!-- Background Image -->
                                    <div style="background-image: url('{{ asset('img/templates/photographer/profile-border.png') }}');"
                                        class="w-full h-full bg-cover absolute top-0 left-0 z-10">
                                    </div>
                                    <!-- Foreground Image -->
                                    <img src="{{ url($business_card_details->profile) }}"
                                        alt="{{ $business_card_details->title }}"
                                        class="w-24 h-24 md:w-[130px] md:h-[130px] rounded-full object-cover absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20" />
                                </div>
                            </div>

                            <div class="relative z-10 flex flex-col w-9/12 lg:ltr:ml-10 lg:rtl:mr-10 ltr:ml-6 rtl:mr-6">
                                {{-- Name --}}
                                <h1 class="lg:text-5xl text-3xl font-medium text-gray-900 head text-start">
                                    {{ $business_card_details->title }}
                                </h1>
                                {{-- Job Title --}}
                                <p class="text-orange-600 text-lg font-bold mt-1 text-md text-start">
                                        ...
                                        @foreach ($feature_details as $feature)
                                            @if (in_array($feature->type, ['tel', 'address', 'wa']))
                                                ...
                                                @if ($feature->type == 'address')
                                                    <a href="#location"
                                                        class="bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] rounded-full flex items-center justify-center w-14 h-14 border border-orange-400 focus:outline-none">
                                                        <i class="{{ $feature->icon }} fa-xl text-orange-700"></i>
                                                    </a>
                                                @endif
                                                {{-- Phone --}}
                                                @if ($feature->type == 'tel')
                                                ...
                                                @if ($feature->type == 'wa')
                                                    <a href="https://wa.me/{{ $feature->content }}"
                                                        class="bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] rounded-full flex items-center justify-center w-14 h-14 border border-orange-400 focus:outline-none">
                                                        <i class="{{ $feature->icon }} fa-2xl text-orange-700"></i>
                                                    </a>
                                                @endif
                                            @endif
                                        @endforeach
                        ...
                        @if (count($feature_details) > 0)
                            @php
                                ...
                                foreach ($feature_details as $feature) {
                                    if (isset($feature->type) && $feature->type === 'address') {
                                        $hasAddressType = true;
                                        break;
                                    }
                                }
                            ...
                            @if ($hasAddressType)
                                <div class="relative">
                                    <img src="{{ asset('img/templates/photographer/8.png') }}" alt=""
                                        class="w-28 absolute -top-[92px] lg:-top-[92px] -left-4 opacity-80" />
                                    @foreach ($feature_details as $feature)
                                            ...
                                            <div class="grid grid-cols-1 gap-4 relative">
                                                <div class="mt-4 w-full">
                                                    ...
                                                    <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                        target="_blank"
                                                        class="px-6 py-4 border border-orange-400 flex flex-col bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] rounded-2xl justify-center focus:outline-none">
                                                        <!-- Font Awesome Icon -->
                                                        <i
                                                            class="{{ $feature->icon }} fa-xl text-orange-700 text-2xl py-4"></i>
                                                        <!-- Title -->
                                                        <h2 class="text-orange-700 text-md font-medium">
                                                            {{ $feature->label }}
                                                        </h2>
                                                        <!-- Description -->
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            ...
                            @if ($visibleFeatures->isNotEmpty())
                                <div class="relative">
                                    <img src="{{ asset('img/templates/photographer/1.png') }}" alt=""
                                        class="w-20 lg:w-32 absolute top-5 lg:top-3 -right-6 -rotate-12 opacity-80" />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-gray-900 py-12 text-center relative head">
                                        <div
                                            ...
                                            @if (!in_array($feature->type, ['tel', 'map', 'iframe', 'youtube', 'address']))
                                                ...
                                                <a href="{{ $href }}" target="_blank"
                                                    ...
                                                    <div class="flex items-center">
                                                        <!-- Font Awesome Icon -->
                                                        <div
                                                            class="w-9 h-9 flex items-center justify-center rounded-full border border-orange-700 -ml-1">
                                                            <i
                                                                class="{{ $feature->icon }} text-orange-700 text-lg"></i>
                                                        </div>
                                                        <!-- Title -->
                                                        <h2
                                                            class="text-orange-700 text-lg font-semibold ml-2 truncate">
                                                            {{ $feature->label }}
                                                        </h2>
                                                    </div>
                                                    <!-- Description -->
                                                    <p class="text-gray-800 text-sm truncate mt-2">
                                                        {{ $feature->content }}
                                                    </p>
                                                </a>
                                            @endif
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/photographer/2.png') }}" alt=""
                                    class="w-28 lg:w-32 absolute top-4 -left-4 opacity-60" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-900 py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] -translate-x-1/2">
                                    ...
                                    @foreach ($galleries_details as $galleries_detail)
                                        <div class="">
                                            ...
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <h3
                                                    class="text-center py-2 text-orange-700 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] rounded-b-2xl text-lg w-full">
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/photographer/3.png') }}" alt=""
                                    class="w-24 lg:w-32 absolute top-3 -right-5 opacity-70" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-900 py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] -translate-x-1/2">
                                ...
                                <div class="slider">
                                    ...
                                    @foreach ($service_details as $service_detail)
                                        <!-- Service -->
                                        <div
                                            class="flex bg-gradient-to-tl from-[#ff7e5f]/30 to-[#feb47b]/30 shadow-[0_0_4px_rgba(0,0,0,0.1)] rounded-3xl justify-center p-6">
                                            {{-- Image --}}
                                            ...
                                            {{-- Description --}}
                                            <p class="text-gray-700 font-normal mb-2">
                                                ...
                                                @if ($enquiry_button != null)
                                                    @if ($whatsAppNumberExists == true && $whatsAppNumberExists == true && $service_detail->enable_enquiry == 'Enabled')
                                                        <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                            target="_blank"
                                                            class="text-orange-700 w-full px-12 lg:w-auto bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] font-medium border border-orange-400 text-base py-2 transition-colors block text-center rounded-xl">
                                                            {{ __('Enquire') }}
                                                        </a>
                                                    @endif
                                                @endif
                            ...
                            <div class="relative">
                                ...
                                <div class="slider">
                                    ...
                                    @foreach ($product_details as $product_detail)
                                        <div
                                            class="flex flex-col bg-gradient-to-tl from-[#ff7e5f]/30 to-[#feb47b]/30 justify-center p-6 rounded-3xl shadow-[0_0_4px_rgba(0,0,0,0.1)]">
                                            {{-- Badge --}}
                                            @if (!empty($product_detail->badge))
                                                <p
                                                    class="absolute top-9 right-9 text-orange-700 font-medium bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] px-4 py-1 border border-orange-400 rounded-xl">
                                                ...
                                                <div class="flex-flex-col">
                                                    <div>
                                                        <h4 class="text-[#000000] text-base font-medium">
                                                            {{ __('Price:') }}
                                                            <span
                                                                class="text-gray-600 font-medium">{{ $product_detail->currency }}
                                                            ...
                                                            @if ($product_detail->sales_price != $product_detail->regular_price)
                                                                <span
                                                                    class="line-through ml-2 text-gray-600 text-base">{{ $product_detail->currency }}
                                                    ...
                                                    <div>
                                                        <h4 class="text-[#000000] text-base font-medium">
                                                            {{ __('Stock:') }}
                                                            <span
                                                                class="text-{{ $product_detail->product_status == 'instock' ? 'orange-500' : 'red-500' }} font-medium">{{ $product_detail->product_status == 'outstock' ? __('Out of Stock') : __('In Stock') }}</span>
                                                        </h4>
                                                    </div>
                                                </div>
                                                    ...
                                                    @if ($whatsAppNumberExists == true)
                                                        <div class="mt-2 w-full">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                target="_blank"
                                                                class="text-orange-700 w-full px-12 lg:w-auto bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] border border-orange-400 text-base font-medium py-2 transition-colors block text-center rounded-xl">
                                                                {{ __('Enquire') }}
                                                            </a>
                                                        </div>
                                                    @endif
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ asset('img/templates/photographer/4.png') }}" alt=""
                                    class="w-28 lg:w-32 absolute top-5 lg:top-2 -left-6 opacity-70" />
                                ...
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        ...
                                        <div
                                            class="overflow-hidden border p-10 bg-gradient-to-tl from-[#ff7e5f]/30 to-[#feb47b]/30 border border-orange-400 rounded-2xl">
                                            ...
                                            <div
                                                ...
                                                <input type="text" id="appointment-date"
                                                    class="flatpickr-input md:w-1/2 rounded-xl w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500"
                                                    placeholder="{{ __('Select a date') }}" required />
                                                <!-- Select time in dropdown -->
                                                <select id="time-slot-select" required
                                                    class="md:w-1/2 w-full px-4 py-3 rounded-xl text-gray-700 bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-3 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] border border-orange-400 rounded-xl text-orange-700 text-lg text-center font-medium focus:outline-none focus:ring-2 focus:ring-orange-500"
                                    ...
                                    <div class="rounded-lg py-4">
                                            ...
                                            <div class="grid grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] text-[#f8f9fa] rounded-full">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock text-orange-700">
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-start space-x-4">
                                                <!-- Animated Icon -->
                                                <div
                                                    class="flex items-center justify-center w-12 h-12 bg-orange-200 text-orange-400 rounded-full transform hover:scale-110 transition-transform duration-300 ease-in-out">
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/photographer/5.png') }}" alt=""
                                    class="w-16 lg:w-24 absolute top-7 lg:top-3 -right-4 opacity-60" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-900 py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] -translate-x-1/2">
                                ...
                                <div
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        <div class="flex flex-col items-center justify-center p-6 lg:p-10 text-center">
                                            {{-- Review --}}
                                            <p class="text-gray-700 text-xl mb-4 italic">
                                                "{{ $testimonial->review }}"
                                            </p>
                                            ...
                                            <div class="flex flex-col justify-center items-center w-full">
                                                ...
                                                <h4 class="text-gray-900 font-bold">
                                                    ...
                                                    @if ($testimonial->review_subtext)
                                                        <span class="text-gray-700 text-sm ml-1">
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div
                                            class="flex flex-col rounded-2xl p-4 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] border border-orange-400">
                                            <div class="flex justify-between items-center">
                                                <!-- {{ $payment->label }} Icon -->
                                                <i class="{{ $payment->icon }} text-orange-700 text-4xl"></i>
                                                <!-- Payment link icon -->
                                                @if ($payment->type == 'url')
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
                                                            class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-orange-700 h-8 w-8">
                                            ...
                                            <h3
                                                class="font-medium text-gray-700 {{ $payment->type == 'text' ? 'py-3' : 'pt-3' }}">
                                                {{ $payment->label }}</h3>
                                            <!-- Bank Details (Optional) -->
                                            @if ($payment->type == 'text')
                                                <p class="text-gray-700 text-sm break-word text-base">
                        ...
                        @if (count($feature_details) > 0 && $feature_details->contains('type', 'map'))
                            <div class="relative" id="location">
                                <img src="{{ asset('img/templates/photographer/6.png') }}" alt=""
                                    class="w-24 lg:w-28 absolute top-9 lg:top-6 -left-3 scale-x-[-1] opacity-70" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-900 py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] -translate-x-1/2">
                                    ...
                                    @if ($feature->type == 'map')
                                        <div>
                                            ...
                                            @if ($feature->label != null)
                                                <div
                                                    class="px-5 py-3 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] rounded-b-2xl">
                                                    <div class="text-orange-700 font-medium text-lg">
                                                        {{ $feature->label }}
                                                    </div>
                                                </div>
                                            @endif
                                    ...
                                    @foreach ($feature_details as $feature)
                                        @if ($feature->type == 'youtube')
                                            ...
                                            <div class="overflow-hidden rounded-2xl">
                                                ...
                                                @if ($feature->label != null)
                                                    <div
                                                        class="px-4 py-4 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b]">
                        ...
                        @if ($feature_details->where('type', 'iframe')->count() > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/photographer/7.png') }}" alt=""
                                    class="w-24 lg:w-28 absolute top-12 lg:top-10 -right-1 opacity-80 z-10" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-900 py-12 text-center relative head">
                                    <div
                                        class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] -translate-x-1/2">
                                ...
                                <div class="grid grid-cols-1 gap-4 items-center ">
                                    ...
                                    @foreach ($feature_details as $feature)
                                        @if ($feature->type == 'iframe')
                                            <div class="overflow-hidden rounded-2xl z-20">
                                                ...
                                                @if ($feature->label != null)
                                                    <div
                                                        class="px-5 py-3 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b]">
                                                        <div class="text-gray-800 font-medium text-lg text-center">
                                                            {{ $feature->label }}
                                                        </div>
                                                    </div>
                                                @endif
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    <img src="{{ asset('img/templates/photographer/8.png') }}" alt=""
                                        class="w-24 lg:w-32 absolute top-[37px] lg:top-[10px] -left-3 " />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-gray-900 py-12 text-center relative head">
                                        <div
                                            class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] -translate-x-1/2">
                                    ...
                                    @if (Session::has('message'))
                                        <div
                                            class="p-4  bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] shadow-md mb-6 rounded-2xl">
                                            <div class="flex items-start">
                                                <div class="mr-4">
                                                    <svg class="w-6 h-6 text-orange-700"
                                    ...
                                    <form
                                        class="w-full max-w-full border p-6 rounded-2xl bg-gradient-to-tl from-[#ff7e5f]/30 to-[#feb47b]/30 border border-orange-400 relative z-10"
                                        ...
                                        <div class="grid grid-cols-1 gap-2 ">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="name" placeholder="Your Name"
                                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500" required />
                                            </div>
                                            {{-- Email --}}
                                            <div>
                                                <label for="email"
                                        ...
                                        <button type="submit"
                                            class="w-full px-4 py-3 bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] border border-orange-400 text-orange-700 text-xl font-medium rounded-2xl focus:outline-none">
                                            {{ __('Send') }}
                                        </button>
                                    </form>
                                </div>
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div
                                ...
                                <div class="mt-2 text-gray-600">
                                    {{ __('Copyright') }} &copy;
                                    <a class="text-orange-700" href="{{ url($card_details->card_url) }}">
                        ...
                        @else
                            <div
                                ...
                                <div class="mt-2 text-gray-600">
                                    {{ __('Made with') }}
                                    <a class="text-orange-700" href="{{ env('APP_URL') }}">
                                        {{ config('app.name') }} </a>
                                    <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                </div>
                            </div>
            ...
            <div
                class="fixed w-full mx-auto left-1/2 bottom-0 px-2 bg-gradient-to-tl from-[#ff7e5f]/50 to-[#feb47b]/50 backdrop-blur-md py-4 flex lg:hidden md:hidden transform -translate-x-1/2 z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="border border-orange-400 p-3 rounded-full bg-gradient-to-tl from-[#e96c50] to-[#e89f6a]"
                        href="#profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-user text-orange-800 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <button
                        class="border border-orange-400 p-3 rounded-full bg-gradient-to-tl from-[#e96c50] to-[#e89f6a]"
                        onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-send text-orange-800 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M10 14l11 -11" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-orange-800 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-line-scan text-orange-800 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex flex-col items-center justify-center">
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-share text-orange-800 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div id="appointmentModal"
            ...
            <!-- Modal Content -->
            <div class="bg-orange-50 rounded-2xl w-full max-w-md p-6 mx-4 shadow-lg">
                <!-- Modal Header -->
                <div class="flex justify-center items-center mb-4">
                    <h2 class="text-xl font-bold text-gray-700">{{ __('Book Appointment') }}</h2>
                </div>
                ...
                <form id="appointmentForm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit" id="bookAppointmentButton"
                            class="bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] text-white px-4 py-2 rounded-lg">
                            {{ __('Submit') }}
                        </button>
                    </div>
                </form>
        ...
        <div id="shareModal"
            ...
            <!-- Modal content -->
            <div class="bg-orange-50 rounded-2xl w-full max-w-md p-6 mx-4 space-y-6"
                ...
                <div class="flex justify-around text-orange-700">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] border border-orange-400 text-orange-700 font-medium py-2 px-4 rounded-2xl w-full">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
        ...
        <div id="whatsappModal"
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-orange-50"
                onclick="event.stopPropagation()">
                ...
                <div>
                    ...
                    <input type="text" id="whatsappNumber" placeholder="e.g., +919876543210"
                        class="w-full mt-1 px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-orange-500" />
                </div>

                <!-- Submit Button -->
                <div class="flex justify-center">
                    <button onclick="sendMessage()"
                        class="bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] border border-orange-400 text-orange-700 font-medium py-2.5 text-lg px-4 rounded-2xl w-full focus:outline-none focus:ring-2 focus:ring-orange-500">
                        {{ __('Send') }}
                    </button>
                </div>
            </div>
        ...
        <div id="scanModal"
            ...
            <!-- Modal content (stops propagation to prevent closing when clicking inside) -->
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-orange-50 qr-modal-overlay"
                onclick="event.stopPropagation()">
                <!-- Qr Code -->
                ...
                <div class="flex justify-center">
                    <button id="download"
                        ...
                        class="bg-gradient-to-tl from-[#ff7e5f] to-[#feb47b] border border-orange-400 font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-orange-700 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" />
                            <path d="M7 11l5 5l5 -5" />
                            <path d="M12 4l0 12" />
