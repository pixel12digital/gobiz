...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/yoga.css') }}">
    {{-- Swiper CSS --}}
...
<body class="bg-orange-100 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto lg:my-8 relative">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
                ...
                <div class="bg-white lg:rounded-2xl shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden">
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-60 relative" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/yoga/banner.png') }}"
                    ...
                    <div class="relative px-6 -mt-0.5 pb-32 lg:p-6">
                        <img src="{{ url('img/templates/yoga/3.png') }}" alt=""
                            class="w-48 z-20 absolute -top-16 -right-[100px] animate-spin"
                        ...
                        <div class="flex justify-center">
                            <img src="{{ url($business_card_details->profile) }}"
                                ...
                                class="w-40 h-40 rounded-full lg:-mt-[110px] -mt-[85px] z-20 bg-transparent object-cover" />
                        </div>

                        {{-- Background Image --}}
                        <div class="text-center mt-4 relative -mx-6">
                            <img src="{{ url('img/templates/yoga/1.png') }}" alt=""
                                class="w-24 z-20 absolute top-1 -left-[10px] " />
                            <img src="{{ url('img/templates/yoga/bg.png') }}"
                                alt="{{ $business_card_details->title }}"
                                class="w-full object-cover absolute -top-[90px] z-10" />
                            <div class="relative z-10">
                                {{-- Name --}}
                                <h1 class="lg:text-5xl text-3xl text-[#121212] head">
                        ...
                        @if (count($feature_details) > 0)
                            <div class="flex justify-center gap-4 mt-8 z-20 relative">
                                <img src="{{ url('img/templates/yoga/2.png') }}" alt=""
                                    class="w-20 lg:w-24 z-20 absolute -top-20 -right-[40px]" />
                                    ...
                                    @if (in_array($feature->type, ['tel', 'email', 'instagram', 'snapchat', 'address']))
                                        ...
                                        @if ($feature->type == 'tel')
                                            <a href="tel:{{ $feature->content }}"
                                                class="bg-orange-50 h-14 w-14 flex justify-center items-center rounded-full hover:bg-orange-100 transition-colors border border-[#9A502D] z-20">
                                                <i class="{{ $feature->icon }} fa-xl text-[#9A502D]"></i>
                                            </a>
                                        @endif
                                        ...
                                        @if ($feature->type == 'instagram')
                                            <a href="{{ $feature->content }}" target="_blank"
                                                class="bg-orange-50 h-14 w-14 flex justify-center items-center rounded-full hover:bg-orange-100 transition-colors border border-[#9A502D] z-20">
                                                <i class="{{ $feature->icon }} fa-2xl text-[#9A502D]"></i>
                                            </a>
                                        @endif
                                    @endif
                                @endforeach
                            ...
                            @foreach ($feature_details as $feature)
                                @if (in_array($feature->type, ['address']))
                                    <div class="grid grid-cols-1 gap-4 relative">
                                        <div
                                            class="mt-8 bg-orange-50 hover:bg-orange-100 transition-colors rounded-2xl border border-[#9A502D] w-full">
                                            <!-- Font Awesome Icon -->
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank" class="px-6 py-4 flex flex-col justify-center">
                                                <!-- Font Awesome Icon -->
                                                <div
                                                    class="w-10 h-10 flex items-center justify-center rounded-full bg-orange-50 border border-[#9A502D] -ml-1">
                                                    <i class="{{ $feature->icon }} text-[#9A502D] text-xl"></i>
                                                </div>
                                                <!-- Title -->
                                                <h2 class="text-gray-600 text-md font-semibold mt-1">
                                                    {{ $feature->label }}
                                                </h2>
                                                <!-- Description -->
                            ...
                            @if ($validFeatures->isNotEmpty())
                                <div class="relative">
                                    <h2
                                        ...
                                        <div class="absolute bottom-10 left-1/2 h-0.5 w-14 bg-[#9A502D] -mx-7 "></div>
                                        {{ __('Social Links') }}
                                    </h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        @foreach ($validFeatures as $feature)
                                            ...
                                            <a href="{{ $href }}" target="_blank"
                                                class="p-4 bg-orange-50 hover:bg-orange-100 transition-colors rounded-2xl flex flex-col border border-[#9A502D]">
                                                <div class="flex items-center">

                                                    <!-- Font Awesome Icon -->
                                                    <div
                                                        class="w-9 h-9 flex items-center justify-center rounded-full bg-orange-50 border border-[#9A502D] -ml-1">
                                                        <i class="{{ $feature->icon }} text-[#9A502D] text-lg"></i>
                                                    </div>
                                                    <!-- Title -->
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ url('img/templates/yoga/4.png') }}" alt=""
                                    class="w-20 lg:w-24 z-20 absolute lg:top-[46px] top-[56px] right-1" />
                                {{-- Check appointment slots in the calendar --}}
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        <h2
                                            class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative head">
                                            <div class="absolute bottom-10 left-1/2 h-0.5 w-14 bg-[#9A502D] -mx-7 ">
                                            </div>
                                            {{ __('Appointment') }}
                                        </h2>

                                        <div
                                            class="overflow-hidden border p-8 bg-orange-50 border border-[#9A502D] rounded-2xl">
                                            <!-- Error Message (hidden by default) -->
                                            <div id="errorMessage" class="text-red-500 text-sm my-2 hidden">
                                                {{ __('Please select a valid date and time slot.') }}</div>

                                            {{-- Success Message (hidden by default) --}}
                                            <div id="successMessage" class="text-orange-500 text-sm my-2 hidden">
                                            ...
                                            <div
                                                ...
                                                <input type="text" id="appointment-date"
                                                    class="flatpickr-input md:w-1/2 rounded-xl w-full px-4 py-2.5 text-[#121212] bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#9A502D] focus:ring-opacity-70"
                                                    placeholder="{{ __('Select a date') }}" />
                                                <!-- Select time in dropdown -->
                                                <select id="time-slot-select"
                                                    class="md:w-1/2 w-full px-4 py-3 rounded-xl text-[#121212] bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#9A502D] focus:ring-opacity-70">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-3 bg-[#9A502D] rounded-xl text-white text-lg text-center font-semibold border border-gray-200"
                                        ...
                                        <swiper-slide class="p-0.5">
                                            ...
                                            <div
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <p
                                                        class="absolute top-9 right-9 font-medium text-white bg-[#9A502D] px-4 py-1 rounded-full">
                                                    ...
                                                    @if ($enquiry_button != null)
                                                        @if ($whatsAppNumberExists == true)
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                target="_blank"
                                                                class="text-[#9A502D] text-sm font-semibold bg-transparent border block text-center border-[#9A502D] py-2 px-4 rounded-lg hover:bg-[#9A502D] hover:text-white focus:outline-none">
                                                                {{ __('Enquire') }}
                                                            </a>
                                                        @endif
                                                    @endif
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                ...
                                <img src="{{ url('img/templates/yoga/5.png') }}" alt=""
                                    class="lg:w-32 w-28 z-20 absolute lg:top-[9px] top-[21px] -left-6" />

                                {{-- All services --}}
                                @foreach ($service_details as $service_detail)
                                    <div
                                        class="mb-5 flex flex-col lg:flex-row items-stretch lg:justify-between shadow-[0_0_4px_rgba(0,0,0,0.1)] rounded-2xl px-4 py-5 border border-[#9A502D] bg-orange-50 relative">                                       
                                        {{-- Service Image --}}
                                            ...
                                            @if ($enquiry_button != null)
                                                @if ($whatsAppNumberExists == true && $whatsAppNumberExists == true && $service_detail->enable_enquiry == 'Enabled')
                                                    ...
                                                    <div class="flex items-start justify-end w-full">
                                                        <div class="flex items-start justify-start ltr:mr-12 rtl:ml-12 w-12 h-12 bg-orange-50 text-orange-600 rounded-full">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                               target="_blank"
                                                               class="text-base font-medium mt-1 px-4 py-2 text-[#9A502D] rounded-lg hover:bg-[#9A502D] hover:text-white border border-[#9A502D] inline-block">{{ __('Enquire') }}</a>
                                                        </div>
                                                    </div>
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <h2
                                 ...
                                 <img src="{{ url('img/templates/yoga/6.png') }}" alt=""
                                    class="w-24 lg:w-28 z-20 absolute -top-[7px] -right-5" />
                                <div>
                                    <swiper-container
                                        breakpoints='{
                                        "640": { "slidesPerView": 1 }, 
                                        ...
                                        space-between="20" class="mySwiper" loop="true" autoplay-delay="3000"
                                        ...
                                        @foreach ($galleries_details as $galleries_detail)
                                            <swiper-slide class="p-0.5">
                                                <!-- Gallery -->
                                                <div
                                                    class="flex flex-col items-center justify-center bg-white p-4 shadow-[0_0_4px_rgba(0,0,0,0.1)] rounded-2xl">
                                                    ...
                                                    <h3
                                                        class="py-1.5 bg-orange-50 border border-[#9A502D] mt-3 text-[#9A502D] text-base w-full text-center rounded-xl ">
                                            ...
                                            <div class="overflow-hidden rounded-2xl">
                                                ...
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-orange-50  ">
                                                        <div class="text-[#9A502D] font-semibold text-lg text-center">
                                                            {{ $feature->label }}
                                                        </div>
                                                    </div>
                                                @endif
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                ...
                                <img src="{{ url('img/templates/yoga/7.png') }}" alt=""
                                    class="w-20 lg:w-24 z-20 absolute top-[20px] -left-6" />
                                <swiper-container class="mySwiper" autoplay-delay="2000"
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        ...
                                        <swiper-slide class="p-1">
                                            <div class="bg-orange-50 p-4 rounded-2xl border border-[#9A502D]">
                                                ...
                                                <p class="text-[#9A502D] font-medium text-sm mt-2 text-end">
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div
                                            class="flex flex-col bg-orange-50 border border-[#9A502D] rounded-2xl p-4">
                                            <div class="flex justify-between items-center">
                                                <!-- {{ $payment->label }} Icon -->

                                                <i class="{{ $payment->icon }} text-[#9A502D] text-4xl"></i>
                                                ...
                                                @if ($payment->type == 'url')
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <div
                                                            class="border border-[#9A502D] bg-orange-100 rounded-full p-2 flex items-center justify-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-[#9A502D] h-6 w-6">
                                    ...
                                    <div class="bg-white rounded-lg py-4">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-[#9A502D] text-[#f8f9fa] rounded-full">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-start space-x-4">
                                                <!-- Animated Icon -->
                                                <div
                                                    class="flex items-center justify-center w-12 h-12 bg-orange-100 text-[#9A502D] rounded-full transform hover:scale-110 transition-transform duration-300 ease-in-out">
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    ...
                                    <img src="{{ url('img/templates/yoga/8.png') }}" alt=""
                                    class="w-24 lg:w-28 z-20 absolute lg:top-[38px] top-[48px] right-2" />

                                    {{-- Message Alert --}}
                                    @if (Session::has('message'))
                                        <div class="px-6 py-4 bg-orange-500 shadow-md mb-6">
                                    ...
                                    {{-- Contact Form --}}
                                    <form
                                        class="w-full max-w-full bg-orange-50 border border-[#9A502D] p-8 rounded-2xl"
                                        ...
                                        <div class="flex flex-col lg:flex-row gap-4 mb-2">
                                            <div class="flex flex-col w-full lg:w-1/2">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#9A502D] focus:ring-opacity-80"
                                                    required />
                                            </div>
                                            <div class="flex flex-col w-full lg:w-1/2">
                                                <label for="email"
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <textarea name="message" placeholder="{{ __('Your Message') }}"
                                                class="w-full px-4 py-3 border border-gray-300 focus:outline-none rounded-lg focus:ring-2 focus:ring-[#9A502D] focus:ring-opacity-80"
                                                required></textarea>
                                        </div>
                                        ...
                                        <div class="flex flex-col ">
                                            <button type="submit"
                                                class="w-full px-4 py-3 bg-[#9A502D] text-white text-xl font-semibold focus:outline-none rounded-xl">
                                                {{ __('Send') }}
                                            </button>
                                        </div>
                                    </form>
                                    ...
                                    @if ($feature->type == 'map')
                                        ...
                                        @if ($feature->label != null)
                                            <div class="px-5 py-3 bg-orange-50 rounded-b-2xl">
                                                <div class="text-[#9A502D] font-semibold text-lg">
                                                    {{ $feature->label }}
                                                </div>
                                            </div>
                                        @endif
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-[#9A502D]" href="{{ url($card_details->card_url) }}">
                        ...
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Made with') }}
                                        <a class="text-[#9A502D]" href="{{ env('APP_URL') }}">
                                            {{ config('app.name') }} </a>
            ...
            <div
                class="fixed w-11/12 left-1/2 bottom-4 bg-orange-200/60 border border-[#9A502D] rounded-full backdrop-blur-md py-4 px-3 flex lg:hidden md:hidden transform -translate-x-1/2 z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="border border-[#9A502D] p-3 rounded-full bg-orange-200" href="#profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-user text-[#9A502D] h-6 w-6">
                ...
                <!-- Send Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-[#9A502D] p-3 rounded-full bg-orange-200"
                        onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-send text-[#9A502D] h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M10 14l11 -11" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="border border-[#9A502D] p-3 rounded-full bg-orange-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-[#9A502D] h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-[#9A502D] p-3 rounded-full bg-orange-200"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-line-scan text-[#9A502D] h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <button class="border border-[#9A502D] p-3 rounded-full bg-orange-200"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-share text-[#9A502D] h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <form id="appointmentForm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit" id="bookAppointmentButton"
                            class="bg-[#9A502D] text-white px-4 py-2 rounded-lg">
                            {{ __('Submit') }}
                        </button>
                    </div>
                </form>
        ...
        <div id="shareModal"
            ...
            <div class="bg-white rounded-xl w-full max-w-md p-6 mx-4 space-y-6" onclick="event.stopPropagation()">
                ...
                <div class="flex justify-around text-[#9A502D]">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-[#9A502D] text-white font-bold py-2 px-4 rounded-xl w-full">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white" onclick="event.stopPropagation()">
                ...
                <div>
                    ...
                    <input type="text" id="whatsappNumber" placeholder="{{ __('e.g., +919876543210') }}"
                        class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#9A502D]" />
                </div>

                <!-- Submit Button -->
                <div class="flex justify-center">
                    <button onclick="sendMessage()"
                        class="bg-[#9A502D] text-white font-bold py-2 px-4 rounded-lg w-full">
                        {{ __('Send') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white qr-modal-overlay"
                ...
                <div class="flex justify-center">
                    <button id="download"
                        ...
                        class="bg-orange-100 border border-[#9A502D] font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-[#9A502D] h-6 w-6">
                            ...
                            <div class="mt-6 space-y-4">
                                <form action="{{ route('check.pwd', $business_card_details->card_id) }}"
                                    ...
                                    <div class="flex flex-col space-y-4 mt-3">
                                        <button type="submit"
                                            class="bg-orange-500 text-white rounded-xl px-4 py-2 mt-2 transition duration-300">{{ __('Password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
