...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/gym.css') }}">
    {{-- Swiper CSS --}}
    ...
    {{-- Google Fonts: Saira Stencil One --}}
...
<body class="bg-[#FDFDFD] min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
                ...
                <div class="bg-white shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden" data-aos="fade-up">
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="h-80 relative" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/gym/banner.png') }}"
                    ...
                    <div class="px-4 lg:px-8 -mt-0.5 pb-28 lg:pb-8">
                        ...
                        {{-- Profile Image --}}
                        <div class="relative z-20 bg-transparent my-4 lg:my-8 flex">
                        ...
                        @if (count($feature_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/gym/1.png') }}" alt=""
                                    class="w-6/12 lg:w-8/12 absolute h-10 top-1 ltr:left-0 rtl:right-0 rtl:transform rtl:scale-x-[-1] -mx-8" />
                                <div class="flex gap-3 lg:gap-3 mt-6 justify-end">
                                        ...
                                        @if (in_array($feature->type, ['tel', 'email', 'instagram', 'facebook']))
                                            ...
                                            @if ($feature->type == 'tel')
                                                <a href="tel:{{ $feature->content }}"
                                                    class="bg-[#F8F8F8] border border-[#121212] rounded-full flex items-center justify-center w-[45px] h-[45px] lg:w-[50px] lg:h-[50px] focus:outline-none z-10">
                                                    <i class="{{ $feature->icon }} fa-xl text-[#121212]"></i>
                                                </a>
                                            @endif
                            ...
                            @foreach ($feature_details as $feature)
                                @if (in_array($feature->type, ['address']))
                                    <div class="flex justify-center relative">
                                        <div class="mt-8 bg-[#F8F8F8] border border-[#121212] w-full">
                                            <!-- Font Awesome Icon -->
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank" class="mx-6 py-4 flex flex-col">

                                                <i class="{{ $feature->icon }} fa-xl text-[#121212] pt-4 pb-3"></i>

                                                <!-- Title -->
                                                <h2 class="text-base font-semibold text-[#121212]">
                                                    {{ $feature->label }}
                                                </h2>
                                                <!-- Description -->
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            ...
                            @if ($validFeatures->isNotEmpty())
                                <div class="relative">
                                    <img src="{{ url('img/templates/gym/2.png') }}" alt=""
                                    ...
                                    <div class="flex items-center mb-8 mt-14">
                                        <span
                                            class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Social Links') }}</span>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        @foreach ($validFeatures as $feature)
                                            ...
                                            <a href="{{ $href }}" target="_blank"
                                                class="p-4 transition-colors flex flex-col bg-[#F8F8F8] border border-[#121212]">
                                                <!-- Font Awesome Icon -->
                                                <i class="{{ $feature->icon }} text-[#121212] text-xl mb-1.5"></i>
                                                <!-- Title -->
                                                <h2 class="text-md font-semibold text-[#121212]">{{ $feature->label }}
                                                </h2>
                                                <!-- Description -->
                        ...
                        @if (count($product_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/gym/8.png') }}" alt=""
                                    class="w-[70px] absolute lg:-top-[53px] -top-[56px] ltr:-left-0 rtl:-right-0 rtl:transform rtl:scale-x-[-1] opacity-50 z-0" />
                                <div class="flex items-center mb-8 mt-14">
                                    <hr class="flex-grow border-[7px] border-gray-800 rtl:ml-6 ltr:mr-6 z-10 relative">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Products') }}</span>
                                </div>
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="relative flex items-center">
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <span
                                                        class="bg-[#121212] text-white text-xs font-semibold px-2.5 py-1.5 absolute top-2 right-2">
                                                        {{ $product_detail->badge }}
                                                    </span>
                                                @endif
                                            </div>
                                            <h3 class="text-[#121212] text-md font-semibold">
                                            ...
                                            <div class="grid grid-cols-1 gap-1 mt-2">
                                                <div class="flex items-center">
                                                    ...
                                                    <span
                                                        class="text-gray-600 text-sm font-semibold">{{ $product_detail->currency }}
                                            ...
                                            @if ($enquiry_button != null)
                                                @if ($whatsAppNumberExists == true)
                                                    <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                        target="_blank"
                                                        class="text-[#121212] text-sm text-center font-semibold mt-4 bg-transparent border border-[#121212] py-2 px-4 focus:outline-none">
                                                        {{ __('Enquire') }}
                                                    </a>
                                                @endif
                                            @endif
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/gym/9.png') }}" alt=""
                                ...
                                <div class="flex items-center mb-8 mt-14">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Services') }}</span>
                                    <hr class="flex-grow border-[7px] border-gray-800 ltr:ml-6 rtl:mr-6">
                                </div>
                                    ...
                                    @foreach ($service_details as $service_detail)
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <img src="{{ url($service_detail->service_image) }}"
                                                ...
                                                class="w-full h-48 object-cover mb-2" />
                                            <!-- Title -->
                                            <h2 class="text-[#121212] text-md font-semibold">
                        ...
                        @if ($feature_details->where('type', 'youtube')->count() > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/gym/10.png') }}" alt=""
                                    class="w-[80px] absolute -top-[57px] ltr:-left-0 rtl:-right-0 rtl:transform rtl:scale-x-[-1] opacity-50 z-0" />
                                <div class="flex items-center mt-14 mb-8">
                                    <hr class="flex-grow border-[7px] border-gray-800 rtl:ml-6 ltr:mr-6 z-10 relative">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Youtube Videos') }}</span>
                                </div>
                        ...
                        @if ($feature_details->where('type', 'iframe')->count() > 0)
                            <div class="relative">
                                <div class="flex items-center mt-14 mb-8">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('IFrame') }}</span>
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/gym/5.png') }}" alt=""
                                    class="lg:w-[90px] w-[80px] absolute lg:-top-[65px] -top-[60px] lg:ltr:-left-10 lg:rtl:-right-9 ltr:-left-8 rtl:-right-8 rtl:transform rtl:scale-x-[-1] opacity-50" />
                                <div class="flex items-center mb-8 mt-14">
                                    <hr class="flex-grow border-[7px] border-gray-800 rtl:ml-6 ltr:mr-6">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Gallery') }}</span>
                                </div>
                                <div>
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/gym/6.png') }}" alt=""
                                    class="lg:w-20 w-14 absolute lg:top-8 top-6 lg:-right-8 -right-4 opacity-20" />
                                <div class="flex items-center mt-14 mb-8">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Client Reviews') }}</span>
                                    <hr class="flex-grow border-[7px] border-gray-800 rtl:mr-6 ltr:ml-6">
                                </div>
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        ...
                                        <swiper-slide class="bg-transparent">
                                            <div class="mb-2 flex flex-col items-center justify-center text-center">
                                                {{-- Review --}}
                                                <p class="text-gray-500 text-lg w-full mt-2 px-8">
                                                    "{{ $testimonial->review }}"
                                                </p>
                                                {{-- Image --}}
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ url('img/templates/gym/7.png') }}" alt=""
                                    class="w-[110px] absolute -top-[77px] ltr:-left-4 rtl:-right-5 rtl:transform rtl:scale-x-[-1] opacity-50 z-0" />
                                ...
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        <div class="flex items-center mt-14 mb-8">
                                            ...
                                            <span
                                                class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Appointment') }}</span>
                                        </div>
                        ...
                        @if (count($payment_details) > 0)
                            <div class="relative">
                                <div class="flex items-center mt-14 mb-8">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Payment Options') }}</span>
                                    <hr class="flex-grow border-[7px] border-gray-800 rtl:mr-6 ltr:ml-6">
                                </div>
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div class="flex flex-col border border-[#121212] bg-[#f8f8f8] p-4">
                                                    ...
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <div class="flex items-center justify-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                ...
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-[#121212] h-7 w-7">
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                <section class="relative">
                                    <img src="{{ url('img/templates/gym/11.png') }}" alt=""
                                        class="lg:w-[120px] w-[90px] absolute lg:-top-[106px] -top-[79px] lg:ltr:-left-2 lg:rtl:-right-2 ltr:-left-2 rtl:-right-2 rtl:transform rtl:scale-x-[-1] opacity-50" />
                                    <div class="flex items-center mt-14 mb-8">
                                        <hr
                                            class="flex-grow border-[7px] border-gray-800 rtl:ml-6 ltr:mr-6 z-10 relative">
                                        <span
                                            class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Business Hours') }}</span>
                                    </div>
                                    <!-- Business Hours Card -->
                        ...
                        @if (count($feature_details) > 0 && $feature_details->contains('type', 'map'))
                            <div class="relative">
                                <div class="flex items-center mt-14 mb-8">
                                    <span
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Location') }}</span>
                                    <hr class="flex-grow border-[7px] border-gray-800 rtl:mr-6 ltr:ml-6">
                                </div>
                                {{-- Google Maps --}}
                                @foreach ($feature_details as $feature)
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    <img src="{{ url('img/templates/gym/4.png') }}" alt=""
                                        class="lg:w-[70px] w-[65px] absolute lg:-top-[65px] -top-[60px] lg:rtl:-left-10 lg:ltr:-right-8 rtl:-left-7 ltr:-right-6 rtl:transform rtl:scale-x-[-1] opacity-50" />
                                    <div class="flex items-center mt-16 mb-8">
                                        <hr class="flex-grow border-[7px] border-gray-800 rtl:ml-6 ltr:mr-6">
                                        <span
                                            class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Contact Us') }}</span>
                                    </div>
            ...
            <div
                class="fixed w-full box-content -mx-auto transform translate-x-1/2 right-1/2 bottom-0 px-2 bg-[#121212]/80  backdrop-blur-md py-4 flex lg:hidden md:hidden z-50">
                <!-- Profile Icon -->
