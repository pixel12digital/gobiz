...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/school.css') }}">
    {{-- Fontawesome CSS --}}
...
<body class="bg-teal-50 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto lg:py-8">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            ...
            @if ($business_card_details != null)
                <div class="bg-white lg:rounded-2xl shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden"
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-72 relative" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/school/banner.png') }}"
                    ...
                    <!-- Profile Info -->
                    <div class="px-6 -mt-0.5 pb-32 lg:p-6 relative">
                        <img src="{{ url('img/templates/school/bg.png') }}" alt=""
                            class="w-full object-cover absolute -mx-6 top-0.5" />
                        <!-- Start Profile Info -->
                        ...
                        <div class="flex justify-center">
                            <img src="{{ url($business_card_details->profile) }}"
                                ...
                                class="w-40 h-40 rounded-full mt-5 z-20 object-cover border-[2px] border-teal-500" />
                        </div>
                        ...
                        <div class="text-center mt-4 relative -mx-6">
                            <div class="relative z-10">
                                {{-- Name --}}
                                <h1 class="lg:text-4xl text-3xl font-medium text-[#121212] head tracking-tighter">
                                    {{ $business_card_details->title }}
                                </h1>
                                {{-- Job Title --}}
                                <p class="text-teal-500 font-bold mt-2 text-md">
                                    {{ $card_details->sub_title }}
                                </p>
                                {{-- About --}}
                                @if (isset($business_card_details->description) || isset($business_card_details->address))
                                    <div
                                        class="mt-4 text-base text-gray-700 leading-relaxed font-medium lg:px-16 px-12 tracking-tight">
                        ...
                        @if (count($feature_details) > 0)
                            <div class="flex justify-center gap-4 mt-6 relative">
                                <img src="{{ asset('img/templates/school/1.png') }}" alt=""
                                    class="lg:w-32 w-28 absolute lg:-top-[25px] -top-3 -right-6 z-10" />
                                ...
                                @foreach ($feature_details as $feature)
                                    @if (in_array($feature->type, ['tel', 'address', 'wa']))
                                        ...
                                        @if ($feature->type == 'address')
                                            <a href="#location"
                                                class="bg-teal-50 border border-teal-500 hover:bg-teal-100 rounded-tr-2xl rounded-tl-md rounded-bl-2xl rounded-br-md flex items-center justify-center w-14 h-14 text-white focus:outline-none">
                                                <i class="{{ $feature->icon }} fa-xl text-teal-500"></i>
                                            </a>
                                        @endif
                                        {{-- Phone --}}
                                        @if ($feature->type == 'tel')
                                        ...
                                        @if ($feature->type == 'wa')
                                            <a href="https://wa.me/{{ $feature->content }}"
                                                class="bg-teal-50 border border-teal-500 hover:bg-teal-100 rounded-tr-2xl rounded-tl-md rounded-bl-2xl rounded-br-md flex items-center justify-center w-14 h-14 text-white focus:outline-none">
                                                <i class="{{ $feature->icon }} fa-2xl text-teal-500"></i>
                                            </a>
                                        @endif
                                    @endif
                                @endforeach
                                    ...
                                    <div class="grid grid-cols-1 gap-4 relative">
                                        <div class="mt-8 -mb-4 w-full">
                                            ...
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank"
                                                class="px-6 py-4 text-white flex flex-col bg-teal-50 border border-teal-500 hover:bg-teal-100 rounded-2xl justify-center">
                                                <!-- Font Awesome Icon -->
                                                <i class="{{ $feature->icon }} fa-xl text-teal-500 text-2xl py-4"></i>
                                                <!-- Title -->
                                ...
                                <div class="relative">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        @foreach ($feature_details as $feature)
                                            ...
                                            @endphp
                                            @if (!in_array($feature->type, ['tel', 'address', 'map', 'iframe', 'youtube']))
                                                <!-- {{ $feature->label }} -->
                                                <a href="{{ $href }}" target="_blank"
                                                    class="p-4 bg-teal-50 border border-teal-500 hover:bg-teal-100 transition-colors rounded-2xl flex flex-col">
                                                    <!-- Font Awesome Icon -->
                                                    <i class="{{ $feature->icon }} text-teal-500 text-xl mb-1"></i>
                                                    <!-- Title -->
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/school/3.png') }}" alt=""
                                    class="lg:w-32 w-24 absolute top-0  -left-5 opacity-60" />
                                <img src="{{ asset('img/templates/school/4.png') }}" alt=""
                                    class="lg:w-28 w-20 absolute top-10 -right-5 opacity-60" />
                                <div class="flex justify-center">
                                    <h2
                                                ...
                                                @if ($enquiry_button != null)
                                                    @if ($whatsAppNumberExists == true && $whatsAppNumberExists == true && $service_detail->enable_enquiry == 'Enabled')
                                                        <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                            target="_blank"
                                                            class="text-white text-center font-semibold mt-4 bg-teal-500 hover:bg-teal-600 border border-teal-700 py-2 px-4 rounded-xl">
                                                            {{ __('Enquire') }}
                                                        </a>
                                                    @endif
                                                @endif
                                ...
                                <div class="slider">
                                    ...
                                    @foreach ($product_details as $product_detail)
                                        <div class="p-2">
                                            <!-- Product -->
                                            <div
                                                class="flex flex-col p-6 rounded-2xl shadow-[0_0_4px_rgba(0,0,0,0.1)] relative">
                                                {{-- Badge --}}
                                                @if (!empty($product_detail->badge))
                                                    <p
                                                        class="absolute top-9 right-9 font-medium text-[#F8F9FA] bg-teal-500 px-4 py-1 rounded-full">
                                                    ...
                                                    @if ($enquiry_button != null)
                                                        @if ($whatsAppNumberExists == true)
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                target="_blank"
                                                                class="text-white font-semibold block text-center py-2 px-4 rounded-xl bg-teal-500 hover:bg-teal-600 border border-teal-700">
                                                                {{ __('Enquire') }}
                                                            </a>
                                                        @endif
                                                    @endif
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/school/6.png') }}" alt=""
                                    class="lg:w-28 w-20 absolute top-1 -left-5 opacity-80" />
                                <img src="{{ asset('img/templates/school/5.png') }}" alt=""
                                    class="lg:w-28 w-20 absolute top-10 -right-5 opacity-80" />
                                <div class="flex justify-center">
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-[#F8F9FA] my-12 bg-teal-700 rounded-2xl px-6 py-2.5 inline-block relative head">
                                        {{ __('Gallery') }}
                                    ...
                                    @foreach ($galleries_details as $galleries_detail)
                                        <div class="">
                                            ...
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <h3
                                                    class="text-center py-2 text-gray-800 bg-teal-100 rounded-b-2xl text-lg w-full">
                                    ...
                                    @foreach ($feature_details as $feature)
                                        @if ($feature->type == 'iframe')
                                            <div class="overflow-hidden rounded-2xl">
                                                ...
                                                {{-- Add Iframe title --}}
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-teal-100">
                                                        <div class="text-gray-700 font-semibold text-lg text-center">
                                                            {{ $feature->label }}
                                                        </div>
                                                    </div>
                                                @endif
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ asset('img/templates/school/7.png') }}" alt=""
                                    class="lg:w-24 w-16 absolute top-3 lg:top-2 -left-5 opacity-80" />
                                <img src="{{ asset('img/templates/school/7.png') }}" alt=""
                                    class="lg:w-24 w-16 absolute top-14 lg:top-12 -right-5 opacity-80" />
                                <div class="flex justify-center">
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-[#F8F9FA] my-12 bg-teal-700 rounded-2xl px-6 py-2.5 inline-block relative head">
                                        {{ __('Client Reviews') }}
                                ...
                                <div class="slider-review bg-[#12562B] border-[8px] border-[#DD803A]">
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        ...
                                        <div class="p-1 rounded-2xl">
                                            <div
                                                class="mb-2 flex flex-col items-center justify-center bg-tranasparent p-6 text-center rounded-2xl">
                                                {{-- Review --}}
                                                <p class="text-white text-lg w-full mt-2 italic">
                                                    "{{ $testimonial->review }}"
                                                </p>
                                                {{-- Image --}}
                                                <img class="w-16 h-16 rounded-full mt-3 mb-1 object-cover"
                                                    src="{{ url($testimonial->reviewer_image) }}"
                                                    alt="{{ $testimonial->reviewer_name }}" />
                                                <div>
                                                    {{-- Name --}}
                                                    <h4 class="text-white font-medium text-lg text-center ">
                                    ...
                                    <div class="bg-white rounded-lg py-4">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-teal-100 rounded-full">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock text-teal-500">
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-start space-x-4">
                                                <!-- Animated Icon -->
                                                <div
                                                    class="flex items-center justify-center w-12 h-12 bg-teal-50 text-teal-500 rounded-full transform hover:scale-110 transition-transform duration-300 ease-in-out">
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ asset('img/templates/school/9.png') }}" alt=""
                                    class="lg:w-28 w-20 absolute top-3 lg:top-0 -left-5 opacity-60" />
                                <img src="{{ asset('img/templates/school/8.png') }}" alt=""
                                    class="lg:w-28 w-20 absolute top-14 lg:top-10 -right-5 opacity-60" />
                                ...
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        ...
                                        <div
                                            class="overflow-hidden border border-teal-500 bg-teal-50 p-8 bg-white rounded-2xl">
                                            ...
                                            <div
                                                class="flex flex-col md:flex-row justify-between mb-5 space-y-2 md:space-y-0 md:gap-4">
                                                <!-- flatpickr Calendar -->
                                                <input type="text" id="appointment-date"
                                                    class="flatpickr-input md:w-1/2 rounded-2xl w-full px-4 py-3 text-[#121212] bg-white border border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-500"
                                                    placeholder="{{ __('Select a date') }}" required />
                                                <!-- Select time in dropdown -->
                                                <select id="time-slot-select" required
                                                    class="md:w-1/2 w-full px-4 py-3 rounded-2xl text-[#121212] bg-white border border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-500">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-2.5 bg-teal-500 border border-teal-600 hover:bg-teal-700 rounded-2xl text-[#F8F9FA] text-lg text-center font-semibold focus:outline-none"
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div class="flex flex-col rounded-2xl p-4 bg-teal-50 border border-teal-500">
                                            <div class="flex justify-between items-center">
                                                <!-- {{ $payment->label }} Icon -->
                                                <i class="{{ $payment->icon }} text-teal-500 text-4xl"></i>
                                                <!-- Payment link icon -->
                                                @if ($payment->type == 'url')
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
                                                            class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-teal-500 h-8 w-8">
                                            ...
                                            <h3
                                                class="font-semibold text-gray-700 {{ $payment->type == 'text' ? 'py-3' : 'pt-3' }}">
                                                {{ $payment->label }}</h3>
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    <img src="{{ asset('img/templates/school/2.png') }}" alt=""
                                        class="lg:w-28 w-20 absolute top-1 lg:top-0 -left-6 opacity-80" />
                                    <img src="{{ asset('img/templates/school/6.png') }}" alt=""
                                        class="lg:w-28 w-20 absolute top-14 -right-6 opacity-80 transform scale-x-[-1]" />
                                    <div class="flex justify-center">
                                        <h2
                                            class="text-3xl lg:text-4xl font-medium text-[#F8F9FA] my-12 bg-teal-700 rounded-2xl px-6 py-2.5 inline-block relative head">
                                            {{ __('Contact Us') }}
                                    ...
                                    @if (Session::has('message'))
                                        <div class="px-6 py-4 bg-teal-500 shadow-md mb-6">
                                    ...
                                    <form class="w-full mx-auto" action="{{ route('sent.enquiry') }}"
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500" required />
                                        </div>
                                        ...
                                        <div class="flex flex-col mb-6">
                                            ...
                                            <textarea name="message" placeholder="{{ __('Your Message') }}"
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500" required></textarea>
                                        </div>
                                        ...
                                        <div class="flex flex-col mb-6">
                                            <button type="submit"
                                                class="w-full px-4 py-3 text-xl bg-teal-500 border border-teal-600 text-white font-semibold rounded-xl">
                                                {{ __('Send') }}
                                            </button>
                                        </div>
                                    </form>
                            ...
                            <div class="relative" id="location">
                                ...
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type == 'map')
                                        ...
                                        {{-- Map title --}}
                                        @if ($feature->label != null)
                                            <div class="px-5 py-3 bg-teal-100 rounded-b-2xl">
                            ...
                            <div class="pb-1 mt-2">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-teal-700" href="{{ url($card_details->card_url) }}">
                        ...
                        @else
                            <div class="pb-1 mt-2">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Made with') }}
                                        <a class="text-teal-700" href="{{ env('APP_URL') }}">
                                            {{ config('app.name') }} </a>
                                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
            ...
            <div
                class="fixed w-11/12 left-1/2 bottom-4 bg-teal-200/40 border border-teal-500 rounded-full backdrop-blur-md py-4 px-3 flex lg:hidden md:hidden transform -translate-x-1/2">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="p-3 rounded-full bg-teal-400" href="#profile">
                ...
                <!-- Send Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="p-3 rounded-full bg-teal-400" onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                ...
                <div class="flex-1 flex items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="p-3 rounded-full bg-teal-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                ...
                <!-- Scan Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="p-3 rounded-full bg-teal-400" onclick="toggleScanModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                ...
                <!-- Share Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="p-3 rounded-full bg-teal-400" onclick="shareToggleModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
        ...
        <div id="shareModal"
            ...
            <div class="bg-white rounded-2xl w-full max-w-md p-6 mx-4 space-y-6" onclick="event.stopPropagation()">
                ...
                <div class="flex justify-around text-teal-500">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-teal-500 text-white font-bold py-2 px-4 rounded-2xl w-full">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white" onclick="event.stopPropagation()">
                ...
                <div>
                    ...
                    <input type="text" id="whatsappNumber" placeholder="{{ __('e.g., +919876543210') }}"
                        class="w-full mt-1 px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-teal-500" />
                </div>

                <!-- Submit Button -->
                <div class="flex justify-center">
                    <button onclick="sendMessage()"
                        class="bg-teal-500 text-white font-bold py-3 px-4 rounded-2xl w-full focus:outline-none focus:ring-2 focus:ring-teal-500">
                        {{ __('Send') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white qr-modal-overlay"
                ...
                <div class="flex justify-center">
                    <button id="download"
                        ...
                        class="bg-teal-500 font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-white h-6 w-6">
                            ...
                            <div class="mt-6 space-y-4">
                                <form action="{{ route('check.pwd', $business_card_details->card_id) }}"
                                    ...
                                    <div class="flex flex-col space-y-4 mt-3">
                                        <button type="submit"
                                            class="bg-teal-500 text-white rounded-2xl px-4 py-2 mt-2 transition duration-300">{{ __('Password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
