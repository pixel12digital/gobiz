...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/taxi.css') }}">
    {{-- Swiper CSS --}}
...
<body class="bg-yellow-200 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            {{-- Check business details --}}
            @if ($business_card_details != null)
                <div class="bg-white shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden" data-aos="fade-up">
                    <!-- Start Cover Image Section -->
                    @if ($business_card_details->cover_type == 'none')
                        <div class="h-60 lg:h-80 relative" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/taxi/banner.png') }}"
                                alt="{{ $business_card_details->title }}" class="w-full h-full object-cover" />
                            <div class="h-4 w-full absolute bottom-0 left-0">
                                <img src="{{ url('img/templates/taxi/1.png') }}" alt=""
                    ...
                    <!-- Profile Info -->
                    <div class="px-4 lg:px-8 -mt-0.5 pb-28 lg:pb-8 relative">
                        <img src="{{ url('img/templates/taxi/bg.png') }}" alt=""
                            class="w-full object-cover absolute -mx-8 -top-8 z-0 opacity-60" />
                        <!-- Start Profile Info -->

                        {{-- Profile Image --}}
                        <div class="relative z-20 bg-transparent my-4 lg:mt-12 lg:mb-8 flex">
                            ...
                            <div
                                class="flex flex-col justify-center items-start ltr:ml-6 rtl:mr-6 ltr:lg:ml-9 rtl:lg:mr-9 z-20">
                                {{-- Name --}}
                                <h1 class="text-xl lg:text-4xl font-extrabold head">
                                    {{ $business_card_details->title }}
                                </h1>
                                {{-- Job Title --}}
                                <p class="text-black font-semibold text-md text-gray-800">
                        ...
                        @if (count($feature_details) > 0)
                            <div class="flex">
                                ...
                                <img src="{{ url('img/templates/taxi/2.png') }}" alt=""
                                    class="w-5/12 lg:w-4/12 h-9 ltr:-ml-5 rtl:-mr-5 lg:ltr:-ml-8 lg:rtl:-mr-8 z-0" />

                                <!-- Button Container -->
                                <div class="ltr:ml-7 rtl:mr-7 -mt-1.5 flex gap-3 lg:gap-3 justify-start relative z-10">
                                        ...
                                        @if (in_array($feature->type, ['tel', 'email', 'instagram', 'facebook']))
                                            ...
                                            @if ($feature->type == 'tel')
                                                <a href="tel:{{ $feature->content }}"
                                                    class="bg-yellow-400 border-2 border-black rounded-full flex items-center justify-center w-[45px] h-[45px] lg:w-[50px] lg:h-[50px] focus:outline-none">
                                                    <i class="{{ $feature->icon }} fa-xl text-black"></i>
                                                </a>
                                            @endif
                            ...
                            @foreach ($feature_details as $feature)
                                @if (in_array($feature->type, ['address']))
                                    <div class="flex justify-center relative">
                                        <div class="mt-8 bg-yellow-400 border-2 border-black w-full">
                                            <!-- Font Awesome Icon -->
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank" class="mx-6 py-4 flex flex-col">

                                                <i class="{{ $feature->icon }} fa-xl text-black pt-4 pb-3"></i>
                                                ...
                                                <!-- Description -->
                                                <p class="text-md mt-1 text-gray-800">
                                                    {{ $feature->content }}
                                                </p>
                                            </a>
                                        </div>
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            @php
                                ...
                                $excludedTypes = ['email', 'tel', 'facebook', 'instagram', 'address', 'map', 'iframe', 'youtube'];

                                // Filter the valid features
                            ...
                            @if ($validFeatures->isNotEmpty())
                                <div class="relative">
                                    <img src="{{ url('img/templates/taxi/4.png') }}" alt=""
                                        class="w-24 absolute -top-14 ltr:-right-2 rtl:-left-2 z-10 opacity-60" />
                                    <img src="{{ url('img/templates/taxi/3.png') }}" alt=""
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        @foreach ($validFeatures as $feature)
                                            ...
                                            <a href="{{ $href }}" target="_blank"
                                                class="p-4 bg-yellow-400 flex flex-col border-2 border-black">
                                                <div class="flex items-center">
                                                    <!-- Font Awesome Icon -->
                                                    <div class="flex items-center justify-center">
                                                        <i class="{{ $feature->icon ?? '' }} text-black text-lg"></i>
                                                    </div>
                                                    <!-- Title -->
                                                    <h2 class="text-gray-900 text-lg font-semibold ml-2 truncate">
                                                        {{ $feature->label ?? 'N/A' }}
                                                    </h2>
                                                </div>
                                                <!-- Description -->
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ url('img/templates/taxi/5.png') }}" alt=""
                                    class="w-36 absolute -top-[38px] ltr:-left-2 rtl:-right-2 rtl:transform rtl:scale-x-[-1] opacity-70" />
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <input type="text" id="appointment-date"
                                                    class="flatpickr-input md:w-1/2 w-full px-4 py-2.5 text-black bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-50"
                                                    placeholder="{{ __('Select a date') }}" />
                                                <!-- Select time in dropdown -->
                                                <select id="time-slot-select"
                                                    class="md:w-1/2 w-full px-4 py-3 text-black bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-50">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-2.5 bg-yellow-400 text-black text-lg text-center font-semibold border-2 border-black"
                                        ...
                                        <swiper-slide class="p-0.5">
                                            ...
                                            <div
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <p
                                                        class="absolute top-9 right-9 font-medium text-black bg-yellow-400 px-3.5 py-1 border-2 border-black">
                                                        ...
                                                        @if ($whatsAppNumberExists == true)
                                                            <div class="mt-4 w-full">
                                                                <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                    target="_blank"
                                                                    class="text-black w-full px-12 lg:w-auto bg-yellow-400 border-2 border-black text-base py-2 block text-center">
                                                                    {{ __('Enquire') }}
                                                                </a>
                                                            </div>
                                                        @endif
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/taxi/6.png') }}" alt=""
                                    class="w-28 absolute -top-14 rtl:-right-3 ltr:-left-3 z-10 opacity-70" />
                                    ...
                                    @foreach ($feature_details as $feature)
                                        @if ($feature->type == 'iframe')
                                            <div class="overflow-hidden">
                                                ...
                                                {{-- Add Iframe title --}}
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-yellow-400">
                                                        <div class="text-black font-semibold text-lg text-center">
                                                            {{ $feature->label }}
                                                        </div>
                                                    </div>
                                                @endif
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/taxi/7.png') }}" alt=""
                                    class="w-24 absolute -top-14 ltr:-right-2 rtl:-left-2 z-10 opacity-80" />
                                <img src="{{ url('img/templates/taxi/3.png') }}" alt=""
                                    class="w-24 absolute -top-[65px] ltr:left-0 rtl:right-0 " />
                                <h2
                                    class="text-3xl font-medium text-black head ltr:text-left mt-[65px] mb-5 rtl:text-right">
                                        ...
                                        @foreach ($galleries_details as $galleries_detail)
                                            <swiper-slide class="p-0.5">
                                                ...
                                                <div
                                                    ...
                                                    <h3
                                                        class="py-2 bg-yellow-400 border-2 border-black mb-3 text-black text-lg w-full text-center">
                                    ...
                                    <div class="bg-white rounded-lg py-4">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-yellow-500 text-black rounded-full">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock text-black">
                                                        ...
                                                        <!-- Day and Hours -->
                                                        <div>
                                                            <p class="text-sm font-semibold text-black capitalize">
                                                                {{ __($day) }}</p>
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-start space-x-4">
                                                <!-- Animated Icon -->
                                                <div
                                                    class="flex items-center justify-center w-12 h-12 bg-yellow-100 text-yellow-500 rounded-full transform hover:scale-110 transition-transform duration-300 ease-in-out">
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/taxi/8.png') }}" alt=""
                                    class="w-20 absolute top-0 ltr:-right-8 rtl:-left-7 z-10 opacity-50 rtl:transform rtl:scale-x-[-1] rtl:scale-y-[-1]" />
                                <img src="{{ url('img/templates/taxi/3.png') }}" alt=""
                                    class="w-24 absolute -top-[65px] ltr:left-0 rtl:right-0 " />
                                <h2
                                    class="text-3xl font-medium text-black head ltr:text-left mt-[65px] mb-5 rtl:text-right">
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        ...
                                        <swiper-slide class="bg-transparent">
                                            <div class="mb-2 flex flex-col items-center justify-center text-center">
                                                {{-- Review --}}
                                                <p class="text-gray-500 text-lg w-full mt-2 px-5 lg:px-8">
                                                    "{{ $testimonial->review }}"
                                                </p>
                                                {{-- Image --}}
                                                <img class="w-14 h-14 rounded-full mt-3 mb-1 object-cover"
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div class="flex flex-col border-2 border-black bg-yellow-400 p-4">
                                            <div class="flex justify-between items-center">
                                                <!-- {{ $payment->label }} Icon -->
                                                <div class="flex items-center justify-center">
                                                    <i class="{{ $payment->icon }} text-black text-4xl"></i>
                                                </div>
                                                <!-- Payment link icon -->
                                                @if ($payment->type == 'url')
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <div class="flex items-center justify-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                ...
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-black h-7 w-7">
                                                                <path stroke="none" d="M0 0h24v24H0z"
                                                                    fill="none" />
                                                                <path
                                            ...
                                            @if ($payment->type == 'text')
                                                <p class="text-gray-800 text-sm break-word text-base">
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    <img src="{{ url('img/templates/taxi/9.png') }}" alt=""
                                    class="w-20 absolute -top-14 rtl:-right-3 ltr:-left-3 z-10 opacity-50" />
                                    <img src="{{ url('img/templates/taxi/3.png') }}" alt=""
                                        class="w-24 absolute -top-[65px] ltr:right-0 rtl:left-0 " />
                                    <h2
                                        class="text-3xl font-medium text-black head ltr:text-right mt-[65px] mb-5 rtl:text-left">
                                    ...
                                    <form class="w-full max-w-full" action="{{ route('sent.enquiry') }}"
                                        ...
                                        <div class="flex flex-col lg:flex-row gap-4 mb-2">
                                            <div class="flex flex-col w-full lg:w-1/2">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    class="w-full px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-80" required />
                                            </div>
                                            <div class="flex flex-col w-full lg:w-1/2">
                                                <label for="email"
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <textarea name="message" placeholder="{{ __('Your Message') }}"
                                                class="w-full px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-80" required></textarea>
                                        </div>
                                        ...
                                        <div class="flex flex-col ">
                                            <button type="submit"
                                                class="w-full px-4 py-2.5 bg-black bg-yellow-400 border-2 border-black text-black text-lg font-semibold focus:outline-none">
                                                {{ __('Send') }}
                                            </button>
                                        </div>
                                    </form>
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-yellow-400" href="{{ url($card_details->card_url) }}">
            ...
            <div
                class="fixed w-full box-content -mx-auto transform translate-x-1/2 right-1/2 bottom-0 px-2 bg-yellow-300/60 backdrop-blur-md py-4 flex lg:hidden md:hidden z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="border-2 border-black p-3 rounded-full bg-yellow-400" href="#profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-user text-black h-6 w-6">
                ...
                <!-- Send Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="border-2 border-black p-3 rounded-full bg-yellow-400"
                        onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-send text-black h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M10 14l11 -11" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="border-2 border-black p-3 rounded-full bg-yellow-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-black h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <!-- Scan Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="border-2 border-black p-3 rounded-full bg-yellow-400" onclick="toggleScanModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-line-scan text-black h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <!-- Share Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="border-2 border-black p-3 rounded-full bg-yellow-400" onclick="shareToggleModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-share text-black h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div id="appointmentModal"
            ...
            <!-- Modal Content -->
            <div class="bg-white w-full max-w-md p-6 mx-4 shadow-lg">
                <!-- Modal Header -->
                ...
                <form id="appointmentForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name"
                            class="mt-1 p-2 border border-gray-300 w-full focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-80" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="notes" class="mt-1 p-2 border border-gray-300 w-full focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-80" rows="3"></textarea>
                    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit" id="bookAppointmentButton"
                            class="bg-yellow-400 text-black px-4 py-2">
                            {{ __('Submit') }}
                        </button>
                    </div>
                </form>
        ...
        <div id="shareModal" class="fixed inset-0 bg-white bg-opacity-80 flex items-center justify-center hidden z-50"
            ...
            <!-- Modal content -->
            <div class="bg-white w-full max-w-md p-6 mx-4 space-y-6 border-2 border-black"
                ...
                <div class="flex justify-around text-yellow-400">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-yellow-400 text-black font-bold py-2 px-4 w-full border-2 border-black">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
        ...
        <div id="whatsappModal"
            ...
            <div class="bg-white border-2 border-black w-full max-w-md p-6 mx-4 space-y-6"
                onclick="event.stopPropagation()">
                <!-- Input for WhatsApp number -->
                <div>
                    <label for="whatsappNumber"
                        class="block text-gray-000">{{ __('Enter WhatsApp Number') }}:</label>
                    <input type="text" id="whatsappNumber" placeholder="{{ __('e.g., +919876543210') }}"
                        class="w-full mt-1 px-4 py-2 border border-gray-500 focus:outline-none focus:border focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-80" />
                </div>
                        ...
                        <div class="bg-white p-6 w-96 max-w-full shadow-lg transform transition-all duration-300"
                            ...
                            <div class="mt-6 space-y-4">
                                <form action="{{ route('check.pwd', $business_card_details->card_id) }}"
                                    ...
                                    {{-- Message --}}
                                    @if (Session::has('message'))
                                        <div class="flex items-center p-4 my-4 text-sm bg-black" role="alert">
                                    ...
                                    <div class="flex flex-col space-y-4 mt-3">
                                        <button type="submit"
                                            class="bg-black text-white px-4 py-2 mt-2 transition duration-300">{{ __('Password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
