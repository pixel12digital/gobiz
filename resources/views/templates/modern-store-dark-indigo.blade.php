                                            ...
                                            <div class="card custom-card-style">
                                                ...
                                                <div class="card-body">
                                                    <div class="badge-container d-flex flex-wrap align-items-center gap-2">
                                                        <span class="badge bg-indigo text-white" id="{{ $product->product_id }}_subtitle">
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                cart_items +=
                    `<p class="text-white mt-1"><strong>${currency} ${jsFormatCurrency(total_price, setDecimalsPlaces, formatType)}</strong></p>`;
                cart_items += `</div>`;
            ...
            if (grandTotal > 0) {
                ...
                cart_items +=
                    `<br><h3 class="pl-4 pt-4 pr-4 font-bold text-white">{{ __('Grand total:') }} ${currency} ${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</h3>`;
            }
