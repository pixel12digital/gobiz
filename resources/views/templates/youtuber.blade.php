...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/youtuber.css') }}">
    {{-- Slick --}}
            ...
            @if ($business_card_details != null)
                <div class="bg-[#000000] shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden" data-aos="fade-up">
                    ...
                    <div class="pt-16 px-6 flex items-center justify-between w-full border-b border-gray-500 pb-4">
                        <!-- Left Side: Image -->
                        <img src="{{ url('img/templates/youtuber/logo.png') }}" alt="Logo"
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-60 p-6" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/youtuber/banner.png') }}"
                    ...
                    <div class="-mt-0.5 pb-32 lg:pb-6">
                        ...
                        <div class="text-center mt-4 relative flex px-6">
                            {{-- Profile Image --}}
                            <div class="w-2/5">
                                <div class="w-36 h-36 lg:w-48 lg:h-48 lg:ml-4 -mt-2 lg:-mt-3 relative">
                                    <!-- Background Image -->
                                    <div style="background-image: url('{{ asset('img/templates/youtuber/profile-bg.png') }}');"
                                        class="w-full h-full bg-cover bg-center absolute top-1 left-0 z-20">
                                    </div>
                                    <!-- Foreground Image -->
                                    <img src="{{ url($business_card_details->profile) }}"
                                        alt="{{ $business_card_details->title }}"
                                        class="w-[120px] h-[120px] md:w-40 md:h-40 rounded-full object-cover absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10" />
                                </div>
                            </div>
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            ...
                            @if ($visibleFeatures->isNotEmpty())
                                <div class="relative border-b border-gray-600 pb-6">
                                    <img src="{{ asset('img/templates/youtuber/1.png') }}" alt=""
                                        class="w-20 absolute top-5 -left-4 -rotate-12" />
                                    <h2
                        ...
                        @if ($feature_details->where('type', 'youtube')->count() > 0)
                            <div class="relative border-b border-gray-600 pb-6">
                                <img src="{{ asset('img/templates/youtuber/2.png') }}" alt=""
                                    class="w-20 absolute top-5 -right-4 -rotate-12" />
                                <h2
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative border-b border-gray-600 pb-6">
                                <img src="{{ asset('img/templates/youtuber/3.png') }}" alt=""
                                    class="w-20 absolute top-5 -left-5" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-50 pt-8 pb-14 text-center relative head">
                                    <div class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gray-500 -translate-x-1/2">
                                    </div>
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative border-b border-gray-600 pb-6">
                                <img src="{{ asset('img/templates/youtuber/4.png') }}" alt=""
                                    class="w-24 absolute top-5 -right-4 -rotate-12" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-50 pt-8 pb-14 text-center relative head">
                                    <div class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gray-500 -translate-x-1/2">
                                    </div>
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative border-b border-gray-600 pb-6">
                                <img src="{{ asset('img/templates/youtuber/4.png') }}" alt=""
                                    class="w-24 absolute top-5 -left-4 rotate-12" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-gray-50 pt-8 pb-14 text-center relative head">
                                    <div class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gray-500 -translate-x-1/2">
                                    </div>
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative px-6">
                                    <img src="{{ asset('img/templates/youtuber/3.png') }}" alt=""
                                    class="w-20 absolute top-5 -right-5" />
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-gray-50 pt-8 pb-14 text-center relative head">
                                        <div
                                            class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gray-500 -translate-x-1/2">
