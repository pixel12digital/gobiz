...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/wedding-1.css') }}">
    {{-- Swiper CSS --}}
...
<body class="bg-yellow-50 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto lg:py-10 pb-20">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
                ...
                <div class="bg-white lg:rounded-2xl shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden relative">
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-60 relative" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/wedding-1/banner.png') }}"
                    ...
                    <img src="{{ url('img/templates/wedding-1/border.png') }}" alt=""
                        class="w-full h-10 lg:h-14 object-cover" />

                    <!-- Profile Info -->
                    <div class="px-6 lg:pb-6 relative">

                        <img src="{{ url('img/templates/wedding-1/bg.png') }}" alt=""
                            class="w-full object-cover absolute -mx-6 -top-0 z-0 opacity-70" />
                        ...
                        <div class="relative z-20 bg-transparent pt-8 flex">
                            ...
                            <div
                                ...
                                {{-- Job Title --}}
                                <p class="text-black font-medium text-md text-pink-900">
                                    ...
                                    @if (in_array($feature->type, ['tel', 'email', 'instagram', 'facebook']))
                                        ...
                                        @if ($feature->type == 'tel')
                                            <a href="tel:{{ $feature->content }}"
                                                class="bg-pink-50 w-14 h-14 flex items-center justify-center rounded-full text-[#80204E] hover:bg-pink-100 transition-colors border border-[#80204E] z-10">
                                        ...
                                        @if ($feature->type == 'facebook')
                                            <a href="{{ $feature->content }}" target="_blank"
                                                class="bg-pink-50 w-14 h-14 flex items-center justify-center rounded-full text-[#80204E] transition-colors border border-[#80204E]">
                                                <i class="{{ $feature->icon }} fa-xl"></i>
                                            </a>
                                        @endif
                            ...
                            <div class="grid grid-cols-1 gap-4 relative mt-8">
                                @foreach ($feature_details as $feature)
                                    @if (in_array($feature->type, ['address']))
                                        <div class="transition-colors rounded-2xl w-full bg-cover bg-center"
                                            style="background-image: url('{{ url('img/templates/wedding-1/card-bg.png') }}')">
                                            <!-- Font Awesome Icon -->
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank" class="p-6 text-pink-900 flex flex-col">

                                                <!-- Font Awesome Icon -->
                                                <i class="{{ $feature->icon }} fa-2xl py-4 px-0.5"></i>

                                                <!-- Title -->
                                                <h2 class="text-base font-medium mt-1.5">{{ $feature->label }}</h2>
                                                <!-- Description -->
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            <div class="relative">
                                ...
                                @if ($hasValidLinks)
                                    <img src="{{ url('img/templates/wedding-1/3.png') }}" alt=""
                                        class="w-24 absolute -top-0 -right-6" />
                                    <h2 class="text-4xl text-gray-800 py-12 text-center relative">
                                        <div class="absolute bottom-9 left-1/2 h-1 w-14 bg-pink-900 -mx-6 "></div>
                                        {{ __('Social Links') }}
                                    </h2>
                                        ...
                                        @foreach ($feature_details as $feature)
                                            ...
                                            @if (isset($feature->type) && !in_array($feature->type, $excludedTypes))
                                                <a href="{{ $href }}" target="_blank"
                                                    class="p-5 transition-colors rounded-2xl flex flex-col bg-cover bg-center"
                                                    style="background-image: url('{{ url('img/templates/wedding-1/card-bg.png') }}');">
                                                    <!-- Font Awesome Icon -->
                                                    <i class="{{ $feature->icon ?? '' }} text-pink-900 text-xl mb-1"></i>
                                                    <!-- Title -->
                                                    <h2 class="text-md font-medium text-pink-900">{{ $feature->label ?? 'N/A' }}</h2>
                                                    <!-- Description -->
                                                    <p class="text-sm truncate text-pink-900">
                                                        {{ $feature->content ?? '' }}
                                                    </p>
                                                </a>
                                            @endif
                        ...
                        @if (count($service_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/wedding-1/1.png') }}" alt=""
                                    class="w-32 absolute -top-0 -left-20 opacity-70 " />
                                <h2 class="text-4xl text-gray-800 py-12 text-center relative ">
                                    <div class="absolute bottom-9 left-1/2 h-1 w-14 bg-pink-900 -mx-6 "></div>
                                    {{ __('Services') }}
                                </h2>
                                <swiper-container slides-per-view="1" class="mySwiper" autoplay-delay="3000"
                                    ...
                                    @foreach ($service_details as $service_detail)
                                        <swiper-slide class="p-1">
                                            <div
                                                class="flex flex-col lg:flex-row items-stretch lg:justify-between rounded-2xl p-4 border border-pink-800 bg-yellow-50 relative shadow-[0_0_4px_rgba(0,0,0,0.1)]">
                                                        ...
                                                        @if ($whatsAppNumberExists == true && $whatsAppNumberExists == true && $service_detail->enable_enquiry == 'Enabled')
                                                            ...
                                                            <div class="flex items-start justify-end w-full">
                                                                <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                                    target="_blank"
                                                                    class="text-base font-medium mt-1 px-4 py-2 bg-pink-900 text-white rounded-lg inline-block">{{ __('Enquire') }}</a>
                                                            </div>
                                                        @endif
                                                    @endif
                                                </div>
                                        ...
                                        <swiper-slide class="p-1">
                                            ...
                                            <div
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <p
                                                        class="absolute top-7 right-7 font-medium text-white bg-pink-900 px-4 py-1 rounded-lg">
                                                        ...
                                                        @if ($whatsAppNumberExists == true)
                                                            <div class="mt-2 w-full">
                                                                <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                    target="_blank"
                                                                    class="text-white w-full px-12 lg:w-auto bg-pink-900 text-base font-medium border border-red-700 py-1.5 rounded-lg transition-colors block text-center">
                                                                    {{ __('Enquire') }}
                                                                </a>
                                                            </div>
                                                        @endif
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/wedding-1/2.png') }}" alt=""
                                    class="w-32 absolute top-1 -right-20 animate-spin"
                                ...
                                <div class="w-full">
                                    <swiper-container slides-per-view="1" class="mySwiper" loop="true"
                                        ...
                                        @foreach ($galleries_details as $galleries_detail)
                                            <swiper-slide class="bg-yellow-50 p-6 border border-pink-900 rounded-2xl">
                                                <!-- Gallery -->
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <h3
                                                        class="py-2 bg-pink-900 mt-6 text-white text-lg w-full text-center rounded-xl">
                                        ...
                                        @if ($feature->type == 'youtube')
                                            ...
                                            <div class="rounded-2xl overflow-hidden">
                                                ...
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-orange-100">
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/wedding-1/6.png') }}" alt=""
                                    class="w-32 absolute top-4 -left-10 opacity-80" />
                                <h2 class="text-4xl text-gray-800 py-12 text-center relative ">
                                    <div class="absolute bottom-9 left-1/2 h-1 w-14 bg-pink-900 -mx-6 "></div>
                                    {{ __('Client Reviews') }}
                                </h2>
                                <swiper-container class="mySwiper" autoplay-delay="2000"
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        ...
                                        <swiper-slide class="p-1 bg-transparent">
                                            <div class="bg-yellow-50 p-6 rounded-2xl border border-pink-800">
                                                ...
                                                <p class="text-gray-800 font-medium text-sm mt-2 text-end">
                                    ...
                                    <div class="bg-white rounded-lg py-4">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-orange-100 text-pink-900 rounded-full">
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-start space-x-4">
                                                <!-- Animated Icon -->
                                                <div
                                                    class="flex items-center justify-center w-12 h-12 bg-pink-100 text-pink-900 rounded-full transform hover:scale-110 transition-transform duration-300 ease-in-out">
                            ...
                            <div class="relative">
                                ...
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        ...
                                        <div
                                            class="shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden bg-yellow-50 border border-pink-800 rounded-2xl p-8">
                                            ...
                                            <div
                                                ...
                                                <input type="text" id="appointment-date"
                                                    class="flatpickr-input md:w-1/2 w-full px-4 py-2.5 text-gray-800 bg-white border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-800 focus:ring-opacity-50"
                                                    placeholder="{{ __('Select a date') }}" />
                                                <!-- Select time in dropdown -->
                                                <select id="time-slot-select"
                                                    class="md:w-1/2 w-full px-4 py-3 text-gray-800 bg-white border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-800 focus:ring-opacity-50">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-2.5 bg-pink-900 text-white text-lg text-center rounded-xl font-medium"
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div class="flex flex-col bg-yellow-50 border border-pink-800 rounded-2xl p-4">
                                            <div class="flex justify-between items-center">
                                                <!-- {{ $payment->label }} Icon -->
                                                <div class="rounded-full p-1 flex items-center justify-center">
                                                    <i class="{{ $payment->icon }} text-pink-900 text-4xl"></i>
                                                </div>
                                                <!-- Payment link icon -->
                                                @if ($payment->type == 'url')
                                                    <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                                        ...
                                                        <div class="rounded-full p-1 flex items-center justify-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                ...
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon icon-tabler icons-tabler-outline icon-tabler-external-link text-pink-900 h-8 w-8">
                                                                <path stroke="none" d="M0 0h24v24H0z"
                                                                    fill="none" />
                                                                <path
                                            ...
                                            <h3
                                                class="font-medium text-pink-900 {{ $payment->type == 'text' ? 'py-3' : 'pt-3' }}">
                                                {{ $payment->label }}</h3>
                                            <!-- Bank Details (Optional) -->
                                            @if ($payment->type == 'text')
                                                <p class="text-pink-900 text-sm break-word text-base">
                            ...
                            <div class="relative">
                                ...
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type == 'map')
                                        ...
                                        {{-- Map title --}}
                                        @if ($feature->label != null)
                                            <div class="px-5 py-2.5 bg-orange-100 rounded-b-2xl">
                                                <div class="text-gray-800 font-medium text-lg">
                                                    {{ $feature->label }}
                                                </div>
                                            </div>
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">
                                    <img src="{{ url('img/templates/wedding-1/4.png') }}" alt=""
                                    class="w-32 absolute top-4 -right-16 opacity-80 ltr:transform ltr:scale-x-[-1] rtl:transform rtl:scale-x-[-1]" />
                                    <h2 class="text-4xl text-gray-800 py-12 text-center relative ">
                                        <div class="absolute bottom-9 left-1/2 h-1 w-14 bg-pink-900 -mx-6 "></div>
                                        {{ __('Contact Us') }}
                                    </h2>
                                    ...
                                    @if (Session::has('message'))
                                        <div
                                            class="px-6 py-4 bg-yellow-50 border border-pink-800 rounded-lg shadow-[0_0_4px_rgba(0,0,0,0.1)] mb-6">
                                    ...
                                    <form class="w-full mx-auto" action="{{ route('sent.enquiry') }}"
                                        ...
                                        <div class="flex flex-col mb-3">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-800"
                                                required />
                                        </div>
                                        ...
                                        <div class="flex flex-col">
                                            <button type="submit"
                                                class="w-full px-4 py-3 bg-pink-900 text-white text-xl font-medium rounded-xl focus:outline-none">
                                                {{ __('Send') }}
                                            </button>
                                        </div>
                                    </form>
                        ...
                        <div class="flex items-center justify-center h-96 w-full">
                            <img src="{{ url('img/templates/wedding-1/5.png') }}" alt="" class="w-80 ml-3" />
                        </div>
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-pink-900" href="{{ url($card_details->card_url) }}">
                        ...
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Made with') }}
                                        <a class="text-pink-900" href="{{ env('APP_URL') }}">
                                            {{ config('app.name') }} </a>
            ...
            <div
                class="fixed w-full box-content -mx-auto transform translate-x-1/2 right-1/2 bottom-0 px-2 bg-pink-800/60 backdrop-blur-md py-4 flex lg:hidden md:hidden z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="p-3 rounded-full bg-pink-800" href="#profile">
                ...
                <!-- Send Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="p-3 rounded-full bg-pink-800"
                ...
                <div class="flex-1 flex items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="p-3 rounded-full bg-pink-800">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
        ...
        <div id="appointmentModal"
            ...
            <!-- Modal Content -->
            <div class="bg-yellow-50 rounded-xl w-full max-w-md p-6 mx-4 shadow-lg">
                <!-- Modal Header -->
                ...
                <form id="appointmentForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name"
                            class="mt-1 p-2 border border-gray-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-pink-800 focus:ring-opacity-50"
                            required>
                    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit" id="bookAppointmentButton"
                            class="bg-pink-900 text-white px-4 py-2 rounded-lg">
                            {{ __('Submit') }}
                        </button>
                    </div>
                </form>
        ...
        <div id="shareModal"
            ...
            <!-- Modal content -->
            <div class="bg-yellow-50 rounded-xl w-full max-w-md p-6 mx-4 space-y-6" onclick="event.stopPropagation()">
                <!-- Modal header -->
                ...
                <div class="flex justify-around text-pink-800">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-pink-900 text-white font-bold py-2 px-4 rounded-xl w-full">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
        ...
        <div id="whatsappModal"
            ...
            <div class="bg-yellow-50 border-red-200 rounded-2xl w-full max-w-md p-6 mx-4 space-y-6"
                ...
                <div>
                    ...
                    <input type="text" id="whatsappNumber" placeholder="{{ __('e.g., +919876543210') }}"
                        class="w-full mt-1 px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-800 focus:ring-opacity-50" />
                </div>

                <!-- Submit Button -->
                <div class="flex justify-center">
                    <button onclick="sendMessage()"
                        class="bg-pink-800 text-white font-bold py-2 px-4 rounded-xl w-full border border-pink-900">
                        {{ __('Send') }}
                    </button>
                </div>
            </div>
        ...
        <div id="scanModal"
            ...
            <!-- Modal content (stops propagation to prevent closing when clicking inside) -->
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 border-red-100 bg-yellow-50 qr-modal-overlay"
                onclick="event.stopPropagation()">
                <!-- Qr Code -->
                ...
                <div class="flex justify-center">
                    <button id="download"
                        ...
                        class="bg-pink-800 font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-white h-6 w-6">
                        ...
                        <div class="bg-white rounded-lg p-6 w-96 max-w-full shadow-lg transform transition-all duration-300"
                            ...
                            <div class="mt-6 space-y-4">
                                <form action="{{ route('check.pwd', $business_card_details->card_id) }}"
                                    ...
                                    {{-- Message --}}
                                    @if (Session::has('message'))
                                        <div class="flex items-center p-4 my-4 text-sm text-red-800 rounded-lg bg-yellow-50 dark:bg-green-800 dark:text-red-400"
                                            role="alert">
