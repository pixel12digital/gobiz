...
(function ($) {
	...
	var lcl = function(obj, settings) {
		...
		var populate_lb = function(el){
			...
			// Get "data-lcl-id" and "data-lcl-thumb" attributes from selected element
			lclId = el.txt;
			lclThumb = el.src;
		...
		$(document).on('click', '.lcl_image_elem', function(e) {
			...
			// Get "data-lcl-id" and "data-lcl-thumb" attributes from the clicked element
			var imageId = lclId;
			var imageThumb = lclThumb;
		
			// Ensure these attributes exist before proceeding
			if (!imageId || !imageThumb) {
				console.error('Missing data-lcl-id or data-lcl-thumb attributes.');
				return;
			}
		
			// Place the image in the "theme-image" class
			$(".theme-image").attr("src", imageThumb);
		
			// Set the imageId in "theme_id" input
			$("input[name='theme_id']").val(imageId);
		
			// Close the lightbox if function `lcl_close` is defined
			if (typeof lcl_close === 'function') {
				lcl_close();
			} else {
				console.warn('lcl_close is not defined.');
			}
		
			// Close the modal
			$('#themeModal').modal('hide');
		
			// Ensure body overflow is reset after modal close
			$('body').css('overflow', 'auto !important');
		
			// console.log('Image ID:', imageId);
			// console.log('Image Thumb:', imageThumb);
		});
